...
function SpurGear(
  ...
  mass)
  return OpenSCAD(lib
  ..[[gear (circular_pitch=]] .. tostring(circular_pitch)
  ..[[, gear_thickness = ]]   .. tostring(gear_thickness)
  ..[[, rim_thickness = ]]    .. tostring(rim_thickness)
  ..[[, hub_thickness = ]]    .. tostring(hub_thickness)
  ..[[, circles=]]            .. tostring(circles)
  ..[[);]], mass)
end

for i = 0,4 do
  c = SpurGear(200+100*i,15,18,20,8, 1+i)
  c.pos=btVector3(-120+i*75,50,20)
  c.col="#777"
  v:add(c)
end
