...
--local floor_w, floor_d = 1200, 1200
...
--local terrain_nx, terrain_nz = 240, 120   -- grid resolution: 2.5-unit cells in both X and Z
...
linkage2 = buildLinkage(linkage_spacing, 54.459, false, 225, v:getParam("Speed"))   -- front face, x=10
linkage3 = buildLinkage(0, 54.459, true, 180, v:getParam("Speed"))                 -- back face,  x=0
linkage4 = buildLinkage(linkage_spacing, 54.459, true, 225, v:getParam("Speed"))   -- back face,  x=10
...
function buildFoot(lk, color)
  ...
  --
  -- outward_extra/inner_gap below are solved algebraically to hit this
  -- new (foot_x, foot_z_len) shape while landing foot_center_z at
...
v:preSim(function(N)
  ...
  linkage2.hingeO2:enableAngularMotor(true, speed, 150.0)
  linkage3.hingeO2:enableAngularMotor(true, speed, 150.0)
  linkage4.hingeO2:enableAngularMotor(true, speed, 150.0)
