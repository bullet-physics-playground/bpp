...
**Features:**
- OpenSCAD-generated cross and pin-disk geometry
- Pin-driven indexing via contact (no direct motor on the cross)
- Locking rim with dwell-phase clearance
- Adjustable pin-disk speed parameter
