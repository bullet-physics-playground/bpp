...
QPixmap lqglwidget_renderPixmap2(QGLWidget *o, int w) {
  return o->renderPixmap(w);
}
QPixmap lqglwidget_renderPixmap3(QGLWidget *o, int w, int h) {
  return o->renderPixmap(w, h);
}

LQGLWidget lqglwidget() {
  return class_<QGLWidget, QWidget>("QGLWidget")
      ...
      .scope[def("convertToGLFormat", &QGLWidget::convertToGLFormat)];
}
...
LQGLVec lqglvec() {
  return class_<qglviewer::Vec>("QGLVec")
      .def(constructor<>())
...
void lquaternion_setFromRotationMatrix(qglviewer::Quaternion &l,
                                       const QList<QList<double>> &v) {
  double m[3][3];
  if (v.count() < 3)
    return;
  if (v[0].count() < 3)
...
qglviewer::Vec lquaternion_getAxisAngle(qglviewer::Quaternion *w,
                                        float &angle) {
  qglviewer::Vec axis;
...
QList<QList<double>>
lquaternion_inverseRotationMatrix(qglviewer::Quaternion *w) {
  float mat[3][3];
...
qglviewer::Quaternion lquaternion_slerp(const qglviewer::Quaternion &a,
                                        const qglviewer::Quaternion &b,
                                        float t) {
...
LQuaternion lquaternion() {
  return myclass_<qglviewer::Quaternion>("Quaternion")
      .def(constructor<>())
      ...
      .class_<qglviewer::Quaternion>::property("value", lquaternion_value,
                                               lquaternion_setValue)
      .scope[def("slerp", &qglviewer::Quaternion::slerp),
...
void lqcamera_setOrientation1(qglviewer::Camera *w, qglviewer::Quaternion &q) {
  w->setOrientation(q);
}
void lqcamera_setOrientation2(qglviewer::Camera *w, float theta, float phi) {
  w->setOrientation(theta, phi);
}
...
QList<QList<double>>
lqcamera_getFrustumPlanesCoefficients(qglviewer::Camera *w) {
  QList<QList<double>> res;
  GLdouble coef[6][4];
...
LQCamera lqcamera() {
  return myclass_<qglviewer::Camera, QObject>("QCamera")
      .def(constructor<>())
      ...
      .def("interpolateToZoomOnPixel",
           &qglviewer::Camera::interpolateToZoomOnPixel)
      ...
      .def("setScreenWidthAndHeight",
           &qglviewer::Camera::setScreenWidthAndHeight)
      ...
      .def("setZClippingCoefficient",
           &qglviewer::Camera::setZClippingCoefficient)
      .def("setHorizontalFieldOfView",
           &qglviewer::Camera::setHorizontalFieldOfView)
      .def("setFOVToFitScene", &qglviewer::Camera::setFOVToFitScene)
      .def("getOrthoWidthHeight", lqcamera_getOrthoWidthHeight,
           pure_out_value(_2))
      .def("getFrustumPlanesCoefficients",
           lqcamera_getFrustumPlanesCoefficients)
      .def("setSceneRadius", &qglviewer::Camera::setSceneRadius)
      .def("setSceneCenter", &qglviewer::Camera::setSceneCenter)
      .def("setSceneCenterFromPixel",
           &qglviewer::Camera::setSceneCenterFromPixel)
      ...
      .def("setRevolveAroundPointFromPixel",
           &qglviewer::Camera::setRevolveAroundPointFromPixel)

      .def("setFlySpeed", &qglviewer::Camera::setFlySpeed)

      .class_<qglviewer::Camera, QObject>::property(
          "position", &qglviewer::Camera::position,
          &qglviewer::Camera::setPosition)
      .property("upVector", &qglviewer::Camera::upVector,
                &qglviewer::Camera::setUpVector)
      .property("viewDirection", &qglviewer::Camera::viewDirection,
                &qglviewer::Camera::setViewDirection)
      .property("rightVector", &qglviewer::Camera::rightVector)
      .property("orientation", &qglviewer::Camera::orientation,
                lqcamera_setOrientation1)
      .property("type", Camera_type, Camera_setType)
      .property("fieldOfView", &qglviewer::Camera::fieldOfView,
                &qglviewer::Camera::setFieldOfView)
      .property("horizontalFieldOfView",
                &qglviewer::Camera::horizontalFieldOfView,
                &qglviewer::Camera::setHorizontalFieldOfView)
      .property("aspectRatio", &qglviewer::Camera::aspectRatio,
                &qglviewer::Camera::setAspectRatio)
      ...
      .property("zNearCoefficient", &qglviewer::Camera::zNearCoefficient,
                &qglviewer::Camera::setZNearCoefficient)
      .property("zClippingCoefficient",
                &qglviewer::Camera::zClippingCoefficient,
                &qglviewer::Camera::setZClippingCoefficient)
      .property("zNear", &qglviewer::Camera::zNear)
      .property("zFar", &qglviewer::Camera::zFar)
      .property("frustumPlanesCoefficients",
                lqcamera_getFrustumPlanesCoefficients)
      .property("sceneRadius", &qglviewer::Camera::sceneRadius,
                &qglviewer::Camera::setSceneRadius)
      .property("sceneCenter", &qglviewer::Camera::sceneCenter,
                &qglviewer::Camera::setSceneCenter)
      .property("distanceToSceneCenter",
                &qglviewer::Camera::distanceToSceneCenter)
      .property("revolveAroundPoint", &qglviewer::Camera::revolveAroundPoint,
                &qglviewer::Camera::setRevolveAroundPoint)

      .property("flySpeed", &qglviewer::Camera::flySpeed,
                &qglviewer::Camera::setFlySpeed);
}
...
void lqglviewer_drawText(QGLViewer *w, int x, int y, const QString &text) {
  w->drawText(x, y, text);
}
void lqglviewer_displayMessage(QGLViewer *w, const QString &text) {
  w->displayMessage(text);
}

void lqglviewer_drawArrow1() { QGLViewer::drawArrow(); }
void lqglviewer_drawArrow2(float length) { QGLViewer::drawArrow(length); }
void lqglviewer_drawArrow3(float length, float radius) {
  QGLViewer::drawArrow(length, radius);
}
void lqglviewer_drawArrow4(float length, float radius, int nbSub) {
  QGLViewer::drawArrow(length, radius, nbSub);
}
void lqglviewer_drawArrow5(float length, float radius) {
  QGLViewer::drawArrow(length, radius);
}
void lqglviewer_drawArrow6(const qglviewer::Vec &from,
                           const qglviewer::Vec &to) {
  QGLViewer::drawArrow(from, to);
}
void lqglviewer_drawArrow7(const qglviewer::Vec &from, const qglviewer::Vec &to,
                           float radius) {
  QGLViewer::drawArrow(from, to, radius);
}
void lqglviewer_drawArrow8(const qglviewer::Vec &from, const qglviewer::Vec &to,
                           float radius, int nbSub) {
  QGLViewer::drawArrow(from, to, radius, nbSub);
}
...
void lqglviewer_drawGrid3(float size, int nbSub) {
  QGLViewer::drawGrid(size, nbSub);
}

void lqglviewer_saveSnapshot1(QGLViewer *w) { w->saveSnapshot(); }
void lqglviewer_saveSnapshot2(QGLViewer *w, bool automatic) {
  w->saveSnapshot(automatic);
}
void lqglviewer_saveSnapshot3(QGLViewer *w, bool automatic, bool overwrite) {
  w->saveSnapshot(automatic, overwrite);
}
void lqglviewer_saveSnapshot2(QGLViewer *w, const QString &name) {
  w->saveSnapshot(name);
}
void lqglviewer_saveSnapshot3(QGLViewer *w, const QString &name,
                              bool overwrite) {
  w->saveSnapshot(name, overwrite);
}

LQGLViewer lqglviewer() {
  return myclass_<QGLViewer, QGLWidget>("QGLViewer")
      .def(constructor<QWidget *>())
      .def(constructor<QWidget *, QGLWidget *>())
      .def(constructor<QWidget *, QGLWidget *, Qt::WindowFlags>())
      ...
      .property("animationPeriod", &QGLViewer::animationPeriod,
                &QGLViewer::setAnimationPeriod)
      .property("animationIsStarted", &QGLViewer::animationIsStarted)

      .property("axisIsDrawn", &QGLViewer::axisIsDrawn,
                &QGLViewer::setAxisIsDrawn)
      .property("gridIsDrawn", &QGLViewer::gridIsDrawn,
                &QGLViewer::setGridIsDrawn)
      .property("FPSIsDisplayed", &QGLViewer::FPSIsDisplayed,
                &QGLViewer::setFPSIsDisplayed)
      .property("textIsEnabled", &QGLViewer::textIsEnabled,
                &QGLViewer::setTextIsEnabled)
      .property("cameraIsEdited", &QGLViewer::cameraIsEdited,
                &QGLViewer::setCameraIsEdited)
      .property("fullScreen", &QGLViewer::isFullScreen,
                &QGLViewer::setFullScreen)
      .property("stereoDisplay", &QGLViewer::displaysInStereo,
                &QGLViewer::setStereoDisplay)
      .property("currentFPS", &QGLViewer::currentFPS)
      .property("aspectRatio", &QGLViewer::aspectRatio)
      .property("backgroundColor", &QGLViewer::backgroundColor,
                &QGLViewer::setBackgroundColor)
      .property("foregroundColor", &QGLViewer::foregroundColor,
                &QGLViewer::setForegroundColor)
      ...
      .property("snapshotFilename", &QGLViewer::snapshotFilename,
                &QGLViewer::setSnapshotFileName)
      .property("snapshotFormat", &QGLViewer::snapshotFormat,
                &QGLViewer::setSnapshotFormat)
      .property("snapshotQuality", &QGLViewer::snapshotQuality,
                &QGLViewer::setSnapshotQuality)
      .property("snapshotCounter", &QGLViewer::snapshotCounter,
      ...
      .property("stateFileName", &QGLViewer::stateFileName,
      ...
      .class_<QGLViewer, QGLWidget>::property(
          "sceneRadius", &QGLViewer::sceneRadius, &QGLViewer::setSceneRadius)
      .property("sceneCenter", &QGLViewer::sceneCenter,
                &QGLViewer::setSceneCenter)
      .property("camera", &QGLViewer::camera, &QGLViewer::setCamera)

      .scope[def("drawArrow", lqglviewer_drawArrow1),
