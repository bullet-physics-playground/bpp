...
QPlainTextEdit *lqplaintextedit_init(QPlainTextEdit *widget,
                                     const object &obj) {
  lqwidget_init(widget, obj);
...
template <>
void table_init_general<QLabel>(const luabind::argument &arg,
                                const object &obj) {
  lqlabel_init(construct<QLabel>(arg), obj);
}

template <>
void table_init_general<QTextEdit>(const luabind::argument &arg,
                                   const object &obj) {
  lqtextedit_init(construct<QTextEdit>(arg), obj);
}

template <>
void table_init_general<QPlainTextEdit>(const luabind::argument &arg,
                                        const object &obj) {
  lqplaintextedit_init(construct<QPlainTextEdit>(arg), obj);
}

template <>
void table_init_general<QLineEdit>(const luabind::argument &arg,
                                   const object &obj) {
  lqlineedit_init(construct<QLineEdit>(arg), obj);
}

int lqlabel_textFormat(QLabel *l) { return l->textFormat(); }
...
LQLabel lqlabel() {
  return myclass_<QLabel, QFrame>("QLabel", lqlabel_set_map)
      .def(constructor<>())
...
int lqtextedit_lineWrapMode(QTextEdit *edit) { return edit->lineWrapMode(); }
...
LQTextEdit lqtextedit() {
  return myclass_<QTextEdit, QAbstractScrollArea>("QTextEdit",
                                                  lqtextedit_set_map)
      .def(constructor<>())
      .def(constructor<const QString &>())
      .def(constructor<const QString &, QWidget *>())
      ...
      .property("undoRedoEnabled", &QTextEdit::isUndoRedoEnabled,
                &QTextEdit::setUndoRedoEnabled)
      .property("lineWrapMode", QTextEdit_lineWrapMode,
                QTextEdit_setLineWrapMode)
      .property("documentTitle", &QTextEdit::documentTitle,
                &QTextEdit::setDocumentTitle)
      .property("overwriteMode", &QTextEdit::overwriteMode,
                &QTextEdit::setOverwriteMode)
      .property("cursorWidth", &QTextEdit::cursorWidth,
                &QTextEdit::setCursorWidth)
      .property("tabChangesFocus", &QTextEdit::tabChangesFocus,
                &QTextEdit::setTabChangesFocus)
      .property("tabStopWidth", &QTextEdit::tabStopWidth,
                &QTextEdit::setTabStopWidth)
      .property("wordWrapMode", QTextEdit_wordWrapMode,
                QTextEdit_setWordWrapMode)
      //.property("verticalScrollBarPolicy", lqtextedit_v_scroll_bar,
      // lqtextedit_set_v_scroll_bar) .property("horizontalScrollBarPolicy",
      // lqtextedit_h_scroll_bar, lqtextedit_set_h_scroll_bar)
      //.property("vScrollBarPolicy", lqtextedit_v_scroll_bar,
      // lqtextedit_set_v_scroll_bar) .property("hScrollBarPolicy",
      // lqtextedit_h_scroll_bar, lqtextedit_set_h_scroll_bar)
      //.property("lineWrapMode", lqtextedit_lineWrapMode,
      // lqtextedit_set_lineWrapMode)
...
bool lqplaintextedit_find(QPlainTextEdit *w, const QString &str) {
  return w->find(str);
}
...
LQPlainTextEdit lqplaintextedit() {
  return myclass_<QPlainTextEdit, QAbstractScrollArea>("QPlainTextEdit",
                                                       lqplaintextedit_set_map)
      .def(constructor<>())
      .def(constructor<const QString &>())
      .def(constructor<const QString &, QWidget *>())
      ...
      .property("backgroundVisible", &QPlainTextEdit::backgroundVisible,
      ...
      .property("centerOnScroll", &QPlainTextEdit::centerOnScroll,
                &QPlainTextEdit::setCenterOnScroll)
      .property("documentTitle", &QPlainTextEdit::documentTitle,
                &QPlainTextEdit::setDocumentTitle)
      .property("readOnly", &QPlainTextEdit::isReadOnly,
                &QPlainTextEdit::setReadOnly)
      .property("undoRedoEnabled", &QPlainTextEdit::isUndoRedoEnabled,
                &QPlainTextEdit::setUndoRedoEnabled)
      .property("lineWrapMode", QPlainTextEdit_lineWrapMode,
                QPlainTextEdit_setLineWrapMode)
      .property("maximumBlockCount", &QPlainTextEdit::maximumBlockCount,
                &QPlainTextEdit::setMaximumBlockCount)
      .property("overwriteMode", &QPlainTextEdit::overwriteMode,
                &QPlainTextEdit::setOverwriteMode)
      .property("cursorWidth", &QPlainTextEdit::cursorWidth,
                &QPlainTextEdit::setCursorWidth)
      .property("tabChangesFocus", &QPlainTextEdit::tabChangesFocus,
                &QPlainTextEdit::setTabChangesFocus)
      .property("tabStopWidth", &QPlainTextEdit::tabStopWidth,
                &QPlainTextEdit::setTabStopWidth)
      .property("wordWrapMode", QPlainTextEdit_wordWrapMode,
                QPlainTextEdit_setWordWrapMode)
      .property("plainText", &QPlainTextEdit::toPlainText,
...
LQLineEdit lqlineedit() {
  return myclass_<QLineEdit, QWidget>("QLineEdit", lqlineedit_set_map)
      .def(constructor<>())
      .def(constructor<const QString &>())
      .def(constructor<const QString &, QWidget *>())
      ...
      .property("placeholderText", &QLineEdit::placeholderText,
