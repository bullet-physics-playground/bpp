...
template <>
void table_init_general<QPoint>(const luabind::argument &arg,
                                const object &obj) {
  lq_general_init(construct<QPoint>(arg), obj, lqpoint_set_map);
}
template <>
void table_init_general<QLine>(const luabind::argument &arg,
                               const object &obj) {
  lq_general_init(construct<QLine>(arg), obj, lqline_set_map);
}
template <>
void table_init_general<QRect>(const luabind::argument &arg,
                               const object &obj) {
  lq_general_init(construct<QRect>(arg), obj, lqrect_set_map);
}

template <>
void table_init_general<QSize>(const luabind::argument &arg,
                               const object &obj) {
  lq_general_init(construct<QSize>(arg), obj, lqsize_set_map);
}

template <>
void table_init_general<QMargins>(const luabind::argument &arg,
                                  const object &obj) {
  lq_general_init(construct<QMargins>(arg), obj, lqmargins_set_map);
}

template <>
void table_init_general<QColor>(const luabind::argument &arg,
                                const object &obj) {
  lq_general_init(construct<QColor>(arg), obj, lqcolor_set_map);
}

template <>
void table_init_general<QBrush>(const luabind::argument &arg,
                                const object &obj) {
...
template <>
void table_init_general<QFont>(const luabind::argument &arg,
                               const object &obj) {
...
LQPoint lqpoint() {
  return myclass_<QPoint>("QPoint", lqpoint_set_map)
      .def(constructor<>())
...
LQLine lqline() {
  return myclass_<QLine>("QLine", lqline_set_map)
      .def(constructor<>())
      ...
      .def("translated",
           (QLine(QLine::*)(const QPoint &) const) & QLine::translated)
...
int lqpolygon_count(QPolygon *p) { return p->count(); }
int lqpolygon_count2(QPolygon *p, const QPoint &pt) { return p->count(pt); }
LQPolygon lqpolygon() {
  return class_<QPolygon>("QPolygon")
      .def(constructor<>())
      .def(constructor<int>())
      ...
      .def("point",
           (void(QPolygon::*)(int, const QPoint &)) & QPolygon::setPoint)
      .def("point", (void(QPolygon::*)(int, int, int)) & QPolygon::setPoint)

      .def("translate", (void(QPolygon::*)(int, int)) & QPolygon::translate)
      .def("translate",
           (void(QPolygon::*)(const QPoint &)) & QPolygon::translate)
      .def("translated",
           (QPolygon(QPolygon::*)(int, int) const) & QPolygon::translated)
      .def("translated",
           (QPolygon(QPolygon::*)(const QPoint &) const) & QPolygon::translated)
...
LQRect lqrect() {
  return myclass_<QRect>("QRect", lqrect_set_map)
      .def(constructor<>())
      .def(constructor<const QPoint &, const QPoint &>())
...
LQSize lqsize() {
  return myclass_<QSize>("QSize", lqsize_set_map)
      .def(constructor<>())
      .def(constructor<int, int>())
...
LQMargins lqmargins() {
  return myclass_<QMargins>("QMargins", lqmargins_set_map)
      .def(constructor<>())
      .def(constructor<int, int, int, int>())
...
LQRegion lqregion() {
  return class_<QRegion>("QRegion")
      ...
      .def("contains",
           (bool(QRegion::*)(const QPoint &) const) & QRegion::contains)
      .def("contains",
           (bool(QRegion::*)(const QRect &) const) & QRegion::contains)
      .def("intersected",
           (QRegion(QRegion::*)(const QRegion &) const) & QRegion::intersected)
      .def("intersected",
           (QRegion(QRegion::*)(const QRect &) const) & QRegion::intersected)
      .def("intersects",
           (bool(QRegion::*)(const QRegion &) const) & QRegion::intersects)
      .def("intersects",
           (bool(QRegion::*)(const QRect &) const) & QRegion::intersects)
      ...
      .def("translated",
           (QRegion(QRegion::*)(int, int) const) & QRegion::translated)
      .def("translated",
           (QRegion(QRegion::*)(const QPoint &) const) & QRegion::translated)
      .def("united",
           (QRegion(QRegion::*)(const QRect &) const) & QRegion::united)
      .def("united",
           (QRegion(QRegion::*)(const QRegion &) const) & QRegion::united)
...
LQColor lqcolor() {
  return myclass_<QColor>("QColor", lqcolor_set_map)
      .def(constructor<>())
...
void lqbursh_set_style(QBrush *f, int s) { f->setStyle(Qt::BrushStyle(s)); }

int lqbursh_get_style(QBrush *f) { return f->style(); }

LQBrush lqbrush() {
  return myclass_<QBrush>("QBrush", lqbrush_set_map)
      .def(constructor<>())
      ...
      .property("color", &QBrush::color,
                (void(QBrush::*)(const QColor &)) & QBrush::setColor)
...
LQPen lqpen() {
  return myclass_<QPen>("QPen", lqpen_set_map)
      .def(constructor<>())
      ...
      .class_<QPen>::property("dashPattern", &QPen::dashPattern,
                              &QPen::setDashPattern);
}
...
int lqfont_get_cap(QFont *f) { return f->capitalization(); }

void lqfont_set_style(QFont *f, int s) { f->setStyle(QFont::Style(s)); }

int lqfont_get_style(QFont *f) { return f->style(); }

LQFont lqfont() {
  return myclass_<QFont>("QFont", lqfont_set_map)
      .def(constructor<>())
