...
LQHostAddress lqhostaddress() {
  return class_<QHostAddress>("QHostAddress")
      .def(constructor<>())
      ...
      .def("setAddress",
           (bool(QHostAddress::*)(const QString &)) & QHostAddress::setAddress)
      .def("setAddress",
           (void(QHostAddress::*)(quint32)) & QHostAddress::setAddress)
...
template <>
void table_init_general<QNetworkProxy>(const luabind::argument &arg,
                                       const object &obj) {
...
LQNetworkProxy lqnetworkproxy() {
  return myclass_<QNetworkProxy>("QNetworkProxy", lqnp_set_map)
      .def(constructor<>())
      ...
      .property("hostName", &QNetworkProxy::hostName,
      ...
      .property("capabilities", QNetworkProxy_capabilities,
                QNetworkProxy_setCapabilities)
      .property("password", &QNetworkProxy::password,
      ...
      .scope[def("applicationProxy", &QNetworkProxy::applicationProxy),
             def("setApplicationProxy", &QNetworkProxy::setApplicationProxy)];
}

bool lqtcpserver_listen1(QTcpServer *w) { return w->listen(); }
...
template <>
void table_init_general<QTcpServer>(const luabind::argument &arg,
                                    const object &obj) {
...
LQTcpServer lqtcpserver() {
  return myclass_<QTcpServer, QObject>("QTcpServer", lqtcpserver_set_map)
      .def(constructor<>())
      ...
      .property("maxPendingConnections", &QTcpServer::maxPendingConnections,
      ...
      .class_<QTcpServer, QObject>::property("serverError",
...
void lqabstractsocket_connectToHost1(QAbstractSocket *w, const QString &a,
                                     quint16 port) {
  w->connectToHost(a, port);
}
void lqabstractsocket_connectToHost2(QAbstractSocket *w, const QHostAddress &a,
                                     quint16 port) {
  w->connectToHost(a, port);
}
...
void lqabstractsocket_setSocketDescriptor2(QAbstractSocket *w, int d,
                                           QAbstractSocket::SocketState s) {
  w->setSocketDescriptor(d, s);
}
bool QAbstractSocket_waitForConnected(QAbstractSocket *w) {
  return w->waitForConnected();
}
bool QAbstractSocket_waitForDisconnected(QAbstractSocket *w) {
  return w->waitForDisconnected();
}
bool QAbstractSocket_waitForBytesWritten(QAbstractSocket *w) {
  return w->waitForBytesWritten();
}
bool QAbstractSocket_waitForReadyRead(QAbstractSocket *w) {
  return w->waitForReadyRead();
}
...
SIGNAL_PROPERYT(lqabstractsocket, error, QAbstractSocket,
                "(QAbstractSocket::SocketError)")
SIGNAL_PROPERYT(lqabstractsocket, hostFound, QAbstractSocket, "()")
SIGNAL_PROPERYT(lqabstractsocket, stateChanged, QAbstractSocket,
...
LQAbstractSocket lqabstractsocket() {
  return myclass_<QAbstractSocket, QObject>("QAbstractSocket", lqabs_set_map)
      .def(constructor<QAbstractSocket::SocketType, QObject *>())
      .def("__call", lqabs_init)
      .def("abort", &QAbstractSocket::abort)
      .def("connectToHost", (void(QAbstractSocket::*)(const QString &, quint16,
                                                      QIODevice::OpenMode)) &
                                QAbstractSocket::connectToHost)
      .def("connectToHost",
           (void(QAbstractSocket::*)(const QHostAddress &, quint16,
                                     QIODevice::OpenMode)) &
               QAbstractSocket::connectToHost)
      ...
      .def("read",
           (QByteArray(QAbstractSocket::*)(qint64)) & QAbstractSocket::read)
      .def("write", (qint64(QAbstractSocket::*)(const char *, qint64)) &
                        QAbstractSocket::write)
      .def("write",
           (qint64(QAbstractSocket::*)(const char *)) & QAbstractSocket::write)
      .def("write", (qint64(QAbstractSocket::*)(const QByteArray &)) &
                        QAbstractSocket::write)
      ...
      .property("error",
                (QAbstractSocket::SocketError(QAbstractSocket::*)() const) &
      ...
      .property("socketDescriptor", &QAbstractSocket::socketDescriptor,
                lqabstractsocket_setSocketDescriptor1)
      ...
      .class_<QAbstractSocket, QObject>::property(
          "proxy", &QAbstractSocket::proxy, &QAbstractSocket::setProxy)
      .property("readBufferSize", &QAbstractSocket::readBufferSize,
...
template <>
void table_init_general<QTcpSocket>(const luabind::argument &arg,
                                    const object &obj) {
  lqtcps_init(construct<QTcpSocket>(arg), obj);
}
LQTcpSocket lqtcpsocket() {
  return myclass_<QTcpSocket, QAbstractSocket>("QTcpSocket", lqtcps_set_map)
      .def(constructor<>())
      .def(constructor<QObject *>())
...
template <>
void table_init_general<QUdpSocket>(const luabind::argument &arg,
                                    const object &obj) {
...
LQUdpSocket lqudpsocket() {
  return myclass_<QUdpSocket, QAbstractSocket>("QUdpSocket", lqudps_set_map)
      .def(constructor<>())
      .def(constructor<QObject *>())
      .def("bind", (bool(QUdpSocket::*)(quint16)) & QUdpSocket::bind)
      .def("bind", lqudpsocket_bind)
      .def("bind", (bool(QUdpSocket::*)(quint16, QUdpSocket::BindMode)) &
                       QUdpSocket::bind)
      .def("bind", (bool(QUdpSocket::*)(const QHostAddress &, quint16,
                                        QUdpSocket::BindMode)) &
                       QUdpSocket::bind)
      .def("bind", (bool(QUdpSocket::*)(const QHostAddress &, quint16)) &
                       QUdpSocket::bind)
      ...
      .def("writeDatagram",
           (qint64(QUdpSocket::*)(const QByteArray &, const QHostAddress &,
                                  quint16)) &
      ...
      .scope[def("test", lqudpsocket_readDatagram2)];
}
...
LQHostInfo lqhostinfo() {
  return class_<QHostInfo>("QHostInfo")
      .def(constructor<>())
      .def(constructor<int>())
      ...
      .property("errorString", &QHostInfo::errorString,
      ...
      .scope[def("abortHostLookup", &QHostInfo::abortHostLookup),
...
LQNetworkInterface lqnetworkinterface() {
  return class_<QNetworkInterface>("QNetworkInterface")
      .def(constructor<>())
      ...
      .scope[def("allAddresses", &QNetworkInterface::allAddresses),
...
LQNetworkAddressEntry lqnetworkaddressentry() {
  return class_<QNetworkAddressEntry>("QNetworkAddressEntry")
      .property("broadcast", &QNetworkAddressEntry::broadcast,
                &QNetworkAddressEntry::setBroadcast)
      .property("ip", &QNetworkAddressEntry::ip, &QNetworkAddressEntry::setIp)
      .property("netmask", &QNetworkAddressEntry::netmask,
                &QNetworkAddressEntry::setNetmask)
      .property("prefixLength", &QNetworkAddressEntry::prefixLength,
