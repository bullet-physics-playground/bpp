...
template <typename T> bool isEvent(QEvent::Type type);

template <typename T> struct myEventFilter : public QObject {
          ...
          if (type(m_obj) == LUA_TFUNCTION) {
            ...
            if (f && c) {
              if (type(f) == LUA_TFUNCTION) {
                ...
                res = call_member<bool>(c, object_cast<const char *>(f), obj,
                                        evt);
              }
            }
          }
...
template <> bool isEvent<QCloseEvent>(QEvent::Type type) {
  return type == QEvent::Close;
}
template <> bool isEvent<QContextMenuEvent>(QEvent::Type type) {
  return type == QEvent::ContextMenu;
}
template <> bool isEvent<QKeyEvent>(QEvent::Type type) {
...
template <> bool isEvent<QWheelEvent>(QEvent::Type type) {
  return type == QEvent::Wheel;
}
template <> bool isEvent<QPaintEvent>(QEvent::Type type) {
  return type == QEvent::Paint;
}
template <> bool isEvent<QTimerEvent>(QEvent::Type type) {
  return type == QEvent::Timer;
}
template <> bool isEvent<QResizeEvent>(QEvent::Type type) {
  return type == QEvent::Resize;
}
template <> bool isEvent<QShowEvent>(QEvent::Type type) {
  return type == QEvent::Show;
}
template <> bool isEvent<QHideEvent>(QEvent::Type type) {
  return type == QEvent::Hide;
}
template <> bool isEvent<QDropEvent>(QEvent::Type type) {
  return type == QEvent::Drop;
}
template <> bool isEvent<QDragEnterEvent>(QEvent::Type type) {
  return type == QEvent::DragEnter;
}
template <> bool isEvent<QDragMoveEvent>(QEvent::Type type) {
  return type == QEvent::DragMove;
}
template <> bool isEvent<QDragLeaveEvent>(QEvent::Type type) {
  return type == QEvent::DragLeave;
}

template <typename T> QObject *event_filter(const object &obj) {
...
LQMouseEvent lqmouseevent() {
  return LQMouseEvent("QMouseEvent")
...
LQWheelEvent lqwheelevent() {
  return LQWheelEvent("QWheelEvent")
...
LQDragMoveEvent lqdragmoveevent() {
  return LQDragMoveEvent("QDragMoveEvent")
      .def("accept", (void(QDragMoveEvent::*)()) & QDragMoveEvent::accept)
      .def("accept",
           (void(QDragMoveEvent::*)(const QRect &)) & QDragMoveEvent::accept)
      .def("ignore", (void(QDragMoveEvent::*)()) & QDragMoveEvent::ignore)
      .def("ignore",
           (void(QDragMoveEvent::*)(const QRect &)) & QDragMoveEvent::ignore)
...
LQDragEnterEvent lqdragenterevent() {
  return LQDragEnterEvent("QDragEnterEvent")
      .scope[def("filter", event_filter<QDragEnterEvent>)];
}

LQDragLeaveEvent lqdragleaveevent() {
  return LQDragLeaveEvent("QDragLeaveEvent")
