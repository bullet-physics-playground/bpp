...
namespace luabind {
template <>
struct default_converter<QPolygon> : native_converter_base<QPolygon> {
...
template <>
struct default_converter<QPolygon const &> : default_converter<QPolygon> {};
} // namespace luabind

bool lqpainter_begin(QPainter *p, QWidget *w) { return p->begin(w); }

bool lqpainter_begin2(QPainter *p, QImage *w) { return p->begin(w); }

bool lqpainter_begin3(QPainter *p, QPixmap *w) { return p->begin(w); }
...
LQPainter lqpainter() {
  return class_<QPainter>("QPainter")
      .def(constructor<>())
      ...
      .def("boundingRect",
           (QRect(QPainter::*)(int, int, int, int, int, const QString &)) &
               QPainter::boundingRect)
      .def("boundingRect",
           (QRect(QPainter::*)(const QRect &, int, const QString &)) &
               QPainter::boundingRect)
      ...
      .def("setBrushOrigin",
           (void(QPainter::*)(const QPoint &)) & QPainter::setBrushOrigin)
      .def("setBrushOrigin",
           (void(QPainter::*)(int, int)) & QPainter::setBrushOrigin)
      .def("setRenderHints", &QPainter::setRenderHints)
      .def("setRenderHint", &QPainter::setRenderHint)
      .def("setRenderHint",
           tag_function<void(QPainter *, QPainter::RenderHint)>(
               boost::bind(&QPainter::setRenderHint, _1, _2, true)))

      .property("brush", &QPainter::brush,
                (void(QPainter::*)(const QBrush &)) & QPainter::setBrush)
      .property("brushOrigin", &QPainter::brushOrigin,
                (void(QPainter::*)(const QPoint &)) & QPainter::setBrushOrigin)
      .property("font", &QPainter::font, &QPainter::setFont)
      .property("pen", &QPainter::pen,
                (void(QPainter::*)(const QPen &)) & QPainter::setPen)
      .property("background", &QPainter::background, &QPainter::setBackground)
      .property("backgroundMode", &QPainter::backgroundMode,
                &QPainter::setBackgroundMode)
      .property("opacity", &QPainter::opacity, &QPainter::setOpacity)
      .property("renderHints", &QPainter::renderHints,
                tag_function<void(QPainter *, QPainter::RenderHints)>(
                    boost::bind(&QPainter::setRenderHints, _1, _2, true)))
      ...
      .def("drawPolygon", tag_function<_CF(_g)>(boost::bind(
                              _CT(_g, Qt::FillRule) & QPainter::drawPolygon, _1,
                              _2, Qt::OddEvenFill)))
      ...
      .def("drawRoundedRect",
           _CT(_r, _d, _d, Qt::SizeMode) & QPainter::drawRoundedRect)
      .def("drawRoundedRect",
           _CT(_ri, _d, _d, Qt::SizeMode) & QPainter::drawRoundedRect)
      .def("drawRoundedRect",
           tag_function<_CF(_r, _d, _d)>(boost::bind(
               _CT(_r, _d, _d, Qt::SizeMode) & QPainter::drawRoundedRect, _1,
               _2, _3, _4, Qt::AbsoluteSize)))
      .def("drawRoundedRect",
           tag_function<_CF(_ri, _d, _d)>(boost::bind(
               _CT(_ri, _d, _d, Qt::SizeMode) & QPainter::drawRoundedRect, _1,
               _2, _3, _4, _5, _6, _7, Qt::AbsoluteSize)))
      ...
      .def("drawImage", tag_function<_CF(_r, _m, _r)>(boost::bind(
                            _CT(_r, _m, _r, _mc) & QPainter::drawImage, _1, _2,
                            _3, _4, Qt::AutoColor)))
      .def("drawImage", _CT(_p, _m, _r, _mc) & QPainter::drawImage)
      .def("drawImage", tag_function<_CF(_p, _m, _r)>(boost::bind(
                            _CT(_p, _m, _r, _mc) & QPainter::drawImage, _1, _2,
                            _3, _4, Qt::AutoColor)))
      .def("drawImage", _CT(_pi, _m, _ri, _mc) & QPainter::drawImage)
      .def("drawImage", tag_function<_CF(_pi, _m, _ri)>(boost::bind(
                            _CT(_pi, _m, _ri, _mc) & QPainter::drawImage, _1,
                            _2, _3, _4, _5, _6, _7, _8, Qt::AutoColor)))
      .def("drawImage", tag_function<_CF(_pi, _m, _pi, _i)>(boost::bind(
                            _CT(_pi, _m, _ri, _mc) & QPainter::drawImage, _1,
                            _2, _3, _4, _5, _6, _7, -1, Qt::AutoColor)))
      .def("drawImage", tag_function<_CF(_pi, _m, _pi)>(boost::bind(
                            _CT(_pi, _m, _ri, _mc) & QPainter::drawImage, _1,
                            _2, _3, _4, _5, _6, -1, -1, Qt::AutoColor)))
      .def("drawImage", tag_function<_CF(_pi, _m, _i)>(boost::bind(
                            _CT(_pi, _m, _ri, _mc) & QPainter::drawImage, _1,
                            _2, _3, _4, _5, 0, -1, -1, Qt::AutoColor)))
      .def("drawImage", tag_function<_CF(_pi, _m)>(boost::bind(
                            _CT(_pi, _m, _ri, _mc) & QPainter::drawImage, _1,
                            _2, _3, _4, 0, 0, -1, -1, Qt::AutoColor)))
...
struct QMyByteArray : public QByteArray {
  operator const uchar *() const { return (const uchar *)data(); }
};
namespace luabind {
template <>
struct default_converter<QMyByteArray> : native_converter_base<QMyByteArray> {
  static int compute_score(lua_State *L, int index) {
    return lua_type(L, index) == LUA_TTABLE ? 0 : -1;
  }
...
QByteArray lqimage_bits(QImage *w) {
  return QByteArray::fromRawData((const char *)((const QImage *)w)->bits(),
                                 w->byteCount());
}

QByteArray lqimage_scanline(QImage *w, int i) {
  return QByteArray::fromRawData((const char *)((const QImage *)w)->scanLine(i),
                                 w->bytesPerLine());
}
...
QImage lqimage_convertToFormat2(QImage *w, QImage::Format f,
                                const QVector<QRgb> &t) {
  return w->convertToFormat(f, t);
}

QImage lqimage_scaled1(QImage *w, const QSize &size) { return w->scaled(size); }
QImage lqimage_scaled2(QImage *w, const QSize &size, Qt::AspectRatioMode arm) {
  return w->scaled(size, arm);
}
QImage lqimage_scaled3(QImage *w, const QSize &size, Qt::AspectRatioMode arm,
                       Qt::TransformationMode tm) {
  return w->scaled(size, arm, tm);
}
QImage lqimage_scaled4(QImage *W, int w, int h) { return W->scaled(w, h); }
QImage lqimage_scaled5(QImage *W, int w, int h, Qt::AspectRatioMode arm) {
  return W->scaled(w, h, arm);
}
QImage lqimage_scaled6(QImage *W, int w, int h, Qt::AspectRatioMode arm,
                       Qt::TransformationMode tm) {
  return W->scaled(w, h, arm, tm);
}

void lqimage_init1(const luabind::argument &arg, const QByteArray &data, int w,
                   int h, QImage::Format f) {
...
void lqimage_init2(const luabind::argument &arg, const QByteArray &data, int w,
                   int h, int bpl, QImage::Format f) {
  QImage *r = construct<QImage>(arg, w, h, f);
...
LQImage lqimage() {
  return class_<QImage>("QImage")
      ...
      .def("convertToFormat",
           (QImage(QImage::*)(QImage::Format, Qt::ImageConversionFlags) const) &
               QImage::convertToFormat)
      .def("convertToFormat",
           (QImage(QImage::*)(QImage::Format, const QVector<QRgb> &,
                              Qt::ImageConversionFlags) const) &
               QImage::convertToFormat)
      ...
      .def("copy", tag_function<QImage(QImage *)>(boost::bind(
                       (QImage(QImage::*)(const QRect &) const) & QImage::copy,
                       _1, QRect())))
      .def("createAlphaMask", &QImage::createAlphaMask)
      .def("createAlphaMask", tag_function<QImage(QImage *)>(boost::bind(
                                  &QImage::createAlphaMask, _1, Qt::AutoColor)))
      .def("createHeuristicMask", &QImage::createHeuristicMask)
      .def("createHeuristicMask", tag_function<QImage(QImage *)>(boost::bind(
                                      &QImage::createHeuristicMask, _1, true)))
      .def("createMaskFromColor", &QImage::createMaskFromColor)
      .def("createMaskFromColor",
           tag_function<QImage(QImage *, QRgb)>(boost::bind(
               &QImage::createMaskFromColor, _1, _2, Qt::MaskInColor)))
      .def("fill", (void(QImage::*)(uint)) & QImage::fill)
      .def("fill", (void(QImage::*)(const QColor &)) & QImage::fill)
      .def("invertPixels", &QImage::invertPixels)
      .def("invertPixels", tag_function<void(QImage *)>(boost::bind(
                               &QImage::invertPixels, _1, QImage::InvertRgb)))
      .def("load",
           (bool(QImage::*)(const QString &, const char *)) & QImage::load)
      .def("load",
           tag_function<bool(QImage *, const QString &)>(boost::bind(
               (bool(QImage::*)(const QString &, const char *)) & QImage::load,
               _1, _2, (const char *)0)))
      .def("loadFromData", (bool(QImage::*)(const QByteArray &, const char *)) &
                               QImage::loadFromData)
      .def("loadFromData",
           tag_function<bool(QImage *, const QByteArray &)>(
               boost::bind((bool(QImage::*)(const QByteArray &, const char *)) &
                               QImage::loadFromData,
                           _1, _2, (const char *)0)))
      .def("mirrored", &QImage::mirrored)
      .def("mirrored", tag_function<QImage(QImage *, bool)>(
                           boost::bind(&QImage::mirrored, _1, _2, true)))
      .def("mirrored", tag_function<QImage(QImage *)>(
                           boost::bind(&QImage::mirrored, _1, false, true)))
      .def("pixel", (QRgb(QImage::*)(const QPoint &) const) & QImage::pixel)
      .def("pixel", (QRgb(QImage::*)(int, int) const) & QImage::pixel)
      .def("pixelIndex",
           (int(QImage::*)(const QPoint &) const) & QImage::pixelIndex)
      .def("pixelIndex", (int(QImage::*)(int, int) const) & QImage::pixelIndex)
      .def("rgbSwapped", &QImage::rgbSwapped)
      .def("save", (bool(QImage::*)(const QString &, const char *, int) const) &
                       QImage::save)
      .def("save", tag_function<bool(QImage *, const QString &, const char *)>(
                       boost::bind((bool(QImage::*)(const QString &,
                                                    const char *, int) const) &
                                       QImage::save,
                                   _1, _2, _3, -1)))
      .def("save",
           tag_function<bool(QImage *, const QString &)>(boost::bind(
               (bool(QImage::*)(const QString &, const char *, int) const) &
                   QImage::save,
               _1, _2, (const char *)0, -1)))
      ...
      .def("scaledToHeight",
           tag_function<QImage(QImage *, int)>(boost::bind(
               &QImage::scaledToHeight, _1, _2, Qt::FastTransformation)))
      .def("scaledToWidth", &QImage::scaledToWidth)
      .def("scaledToWidth",
           tag_function<QImage(QImage *, int)>(boost::bind(
               &QImage::scaledToWidth, _1, _2, Qt::FastTransformation)))
      .def("scanLine", lqimage_scanline)
      .def("setScanLine", lqimage_set_scanLine)
      .def("setColor", &QImage::setColor)
      .def("setPixel",
           (void(QImage::*)(const QPoint &, uint)) & QImage::setPixel)
      .def("setPixel", (void(QImage::*)(int, int, uint)) & QImage::setPixel)
      .def("setText", (void(QImage::*)(const QString &, const QString &)) &
                          QImage::setText)
      .def("text", (QString(QImage::*)(const QString &) const) & QImage::text)
      .def("text",
           tag_function<QString(QImage *)>(boost::bind(
               (QString(QImage::*)(const QString &) const) & QImage::text, _1,
               QString())))
      ...
      .property("dotsPerMeterX", &QImage::dotsPerMeterX,
                &QImage::setDotsPerMeterX)
      .property("dotsPerMeterY", &QImage::dotsPerMeterY,
      ...
      .scope[def("fromData", (QImage(*)(const QByteArray &, const char *)) &
                                 QImage::fromData),
             def("fromData",
                 tag_function<QImage(const QByteArray &)>(
                     boost::bind((QImage(*)(const QByteArray &, const char *)) &
                                     QImage::fromData,
                                 _1, (const char *)0)))];
}

QPixmap lqpixmap_scaled1(QPixmap *w, const QSize &size) {
  return w->scaled(size);
}
QPixmap lqpixmap_scaled2(QPixmap *w, const QSize &size,
                         Qt::AspectRatioMode arm) {
  return w->scaled(size, arm);
}
QPixmap lqpixmap_scaled3(QPixmap *w, const QSize &size, Qt::AspectRatioMode arm,
                         Qt::TransformationMode tm) {
  return w->scaled(size, arm, tm);
}
QPixmap lqpixmap_scaled4(QPixmap *W, int w, int h) { return W->scaled(w, h); }
QPixmap lqpixmap_scaled5(QPixmap *W, int w, int h, Qt::AspectRatioMode arm) {
  return W->scaled(w, h, arm);
}
QPixmap lqpixmap_scaled6(QPixmap *W, int w, int h, Qt::AspectRatioMode arm,
                         Qt::TransformationMode tm) {
  return W->scaled(w, h, arm, tm);
}
void lqpixmap_scroll1(QPixmap *W, int dx, int dy, int x, int y, int w, int h) {
  W->scroll(dx, dy, x, y, w, h);
}
void lqpixmap_scroll2(QPixmap *W, int dx, int dy, const QRect &rect) {
  W->scroll(dx, dy, rect);
}

LQPixmap lqpixmap() {
  return class_<QPixmap>("QPixmap")
      .def(constructor<>())
      ...
      .def("copy",
           (QPixmap(QPixmap::*)(int, int, int, int) const) & QPixmap::copy)
      .def("copy",
           tag_function<QPixmap(QPixmap *)>(boost::bind(
               (QPixmap(QPixmap::*)(const QRect &) const) & QPixmap::copy, _1,
               QRect())))
      .def("createHeuristicMask", &QPixmap::createHeuristicMask)
      .def("createHeuristicMask", tag_function<QPixmap(QPixmap *)>(boost::bind(
                                      &QPixmap::createHeuristicMask, _1, true)))
      .def("createMaskFromColor",
           (QBitmap(QPixmap::*)(const QColor &, Qt::MaskMode) const) &
               QPixmap::createMaskFromColor)
      .def("createMaskFromColor", (QBitmap(QPixmap::*)(const QColor &) const) &
                                      QPixmap::createMaskFromColor)
      .def("detach", &QPixmap::detach)
      .def("fill", (void(QPixmap::*)(const QColor &)) & QPixmap::fill)
      .def("fill", tag_function<void(QPixmap *)>(boost::bind(
                       (void(QPixmap::*)(const QColor &)) & QPixmap::fill, _1,
                       Qt::white)))
      .def("fill",
           (void(QPixmap::*)(const QWidget *, const QPoint &)) & QPixmap::fill)
      .def("fill",
           (void(QPixmap::*)(const QWidget *, int, int)) & QPixmap::fill)
      .def("load", &QPixmap::load)
      .def("load", tag_function<bool(QPixmap *, const QString &, const char *)>(
                       boost::bind(&QPixmap::load, _1, _2, _3, Qt::AutoColor)))
      .def("load", tag_function<bool(QPixmap *, const QString &)>(boost::bind(
                       &QPixmap::load, _1, _2, (const char *)0, Qt::AutoColor)))
      .def("loadFromData", (bool(QPixmap::*)(const QByteArray &, const char *,
                                             Qt::ImageConversionFlags)) &
                               QPixmap::loadFromData)
      .def("loadFromData",
           tag_function<bool(QPixmap *, const QByteArray &, const char *)>(
               boost::bind((bool(QPixmap::*)(const QByteArray &, const char *,
                                             Qt::ImageConversionFlags)) &
                               QPixmap::loadFromData,
                           _1, _2, _3, Qt::AutoColor)))
      .def("loadFromData",
           tag_function<bool(QPixmap *, const QByteArray &)>(
               boost::bind((bool(QPixmap::*)(const QByteArray &, const char *,
                                             Qt::ImageConversionFlags)) &
                               QPixmap::loadFromData,
                           _1, _2, (const char *)0, Qt::AutoColor)))
      .def("save",
           (bool(QPixmap::*)(const QString &, const char *, int) const) &
               QPixmap::save)
      .def("save", tag_function<bool(QPixmap *, const QString &, const char *)>(
                       boost::bind((bool(QPixmap::*)(const QString &,
                                                     const char *, int) const) &
                                       QPixmap::save,
                                   _1, _2, _3, -1)))
      .def("save",
           tag_function<bool(QPixmap *, const QString &)>(boost::bind(
               (bool(QPixmap::*)(const QString &, const char *, int) const) &
                   QPixmap::save,
               _1, _2, (const char *)0, -1)))
      ...
      .def("scaledToHeight",
           tag_function<QPixmap(QPixmap *, int)>(boost::bind(
               &QPixmap::scaledToHeight, _1, _2, Qt::FastTransformation)))
      .def("scaledToWidth", &QPixmap::scaledToWidth)
      .def("scaledToWidth",
           tag_function<QPixmap(QPixmap *, int)>(boost::bind(
               &QPixmap::scaledToWidth, _1, _2, Qt::FastTransformation)))
      ...
      .scope[def("defaultDepth", &QPixmap::defaultDepth),
             def("fromImage", &QPixmap::fromImage),
             def("fromImage", tag_function<QPixmap(const QImage &)>(boost::bind(
                                  &QPixmap::fromImage, _1, Qt::AutoColor))),
             def("grabWidget",
                 (QPixmap(*)(QWidget *, const QRect &)) & QPixmap::grabWidget),
             def("grabWidget", (QPixmap(*)(QWidget *, int, int, int, int)) &
                                   QPixmap::grabWidget),
             def("grabWidget",
                 tag_function<QPixmap(QWidget *, int, int, int)>(
                     boost::bind((QPixmap(*)(QWidget *, int, int, int, int)) &
                                     QPixmap::grabWidget,
                                 _1, _2, _3, _4, -1))),
             def("grabWidget",
                 tag_function<QPixmap(QWidget *, int, int)>(
                     boost::bind((QPixmap(*)(QWidget *, int, int, int, int)) &
                                     QPixmap::grabWidget,
                                 _1, _2, _3, -1, -1))),
             def("grabWidget",
                 tag_function<QPixmap(QWidget *, int)>(
                     boost::bind((QPixmap(*)(QWidget *, int, int, int, int)) &
                                     QPixmap::grabWidget,
                                 _1, _2, 0, -1, -1))),
             def("grabWidget", tag_function<QPixmap(QWidget *)>(boost::bind(
                                   (QPixmap(*)(QWidget *, int, int, int, int)) &
                                       QPixmap::grabWidget,
                                   _1, 0, 0, -1, -1)))]
...
QBitmap lqbitmap_fromData2(const QSize &size, const QByteArray &arr,
                           QImage::Format f) {
...
LQBitmap lqbitmap() {
  return class_<QBitmap, QPixmap>("QBitmap")
      .def(constructor<>())
      .def(constructor<const QPixmap &>())
      .def(constructor<const QSize &>())
      .def(constructor<int, int>())
      ...
      .scope[def("fromData", lqbitmap_fromData1),
