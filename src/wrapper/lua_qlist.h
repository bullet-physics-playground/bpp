...
struct QListWidgetItem_wrap : public QListWidgetItem, wrap_base {
  QListWidgetItem_wrap(QListWidget *view = 0, int type = Type)
      : QListWidgetItem(view, type) {}
  QListWidgetItem_wrap(const QString &text, QListWidget *view = 0,
                       int type = Type)
  ...
  static bool def_lt(const QListWidgetItem &This,
...
struct QTreeWidgetItem_wrap : public QTreeWidgetItem, wrap_base {
  ...
  QTreeWidgetItem_wrap(const QStringList &text, int type = Type)
      : QTreeWidgetItem(text, type) {}
  QTreeWidgetItem_wrap(QTreeWidget *view, int type = Type)
      : QTreeWidgetItem(view, type) {}
  QTreeWidgetItem_wrap(QTreeWidget *view, const QStringList &text,
                       int type = Type)
      : QTreeWidgetItem(view, text, type) {}
  QTreeWidgetItem_wrap(QTreeWidget *view, QTreeWidgetItem *after,
                       int type = Type)
      : QTreeWidgetItem(view, after, type) {}
  QTreeWidgetItem_wrap(QTreeWidgetItem *parent, int type = Type)
      : QTreeWidgetItem(parent, type) {}
  QTreeWidgetItem_wrap(QTreeWidgetItem *parent, const QStringList &text,
                       int type = Type)
      : QTreeWidgetItem(parent, text, type) {}
  QTreeWidgetItem_wrap(QTreeWidgetItem *parent, QTreeWidgetItem *after,
                       int type = Type)
  ...
  static void def_setData(QTreeWidgetItem *p, int column, int role,
                          const QVariant &data) {
  ...
  static bool def_lt(const QTreeWidgetItem &This,
...
struct QTableWidgetItem_wrap : public QTableWidgetItem, wrap_base {
  ...
  QTableWidgetItem_wrap(const QString &text, int type = Type)
      : QTableWidgetItem(text, type) {}
  QTableWidgetItem_wrap(const QIcon &icon, const QString &text, int type = Type)
      : QTableWidgetItem(icon, text, type) {}
  QTableWidgetItem_wrap(const QTableWidgetItem &other)
  ...
  static bool def_lt(const QTableWidgetItem &This,
