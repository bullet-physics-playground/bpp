...
template <>
void table_init_general<QCheckBox>(const luabind::argument &arg,
                                   const object &obj) {
...
QPushButton *lqpb_init(QPushButton *widget, const object &obj) {
  ...
  for (iterator i(obj), e; i != e; ++i) {
    if (type(*i) == LUA_TUSERDATA) {
      if (q_cast(*i, (void(QPushButton::*)(QMenu *)) & QPushButton::setMenu,
                 widget)) {
      }
    }
  }
...
template <>
void table_init_general<QPushButton>(const luabind::argument &arg,
                                     const object &obj) {
...
template <>
void table_init_general<QRadioButton>(const luabind::argument &arg,
                                      const object &obj) {
...
template <>
void table_init_general<QToolButton>(const luabind::argument &arg,
                                     const object &obj) {
...
QButtonGroup *lqbg_init(QButtonGroup *widget, const object &obj) {
  ...
  for (iterator i(obj), e; i != e; ++i) {
    if (type(*i) == LUA_TUSERDATA) {
      ...
      try {
        btn = object_cast<QAbstractButton *>(*i);
      } catch (...) {
      }
      if (btn) {
...
template <>
void table_init_general<QButtonGroup>(const luabind::argument &arg,
                                      const object &obj) {
  lqbg_init(construct<QButtonGroup>(arg), obj);
}

LQAbstractButton lqabstractbutton() {
  return myclass_<QAbstractButton, QAbstractButtonWrap, QWidget>(
             "QAbstractButton", lqab_set_map)
      .def(constructor<>())
      .def(constructor<QWidget *>())

      .property("autoExclusive", &QAbstractButton::autoExclusive,
                &QAbstractButton::setAutoExclusive)
      .property("checkable", &QAbstractButton::isCheckable,
                &QAbstractButton::setCheckable)
      .property("checked", &QAbstractButton::isChecked,
      ...
      .class_<QAbstractButton, QAbstractButtonWrap, QWidget>::property(
          "shortcut", &QAbstractButton::shortcut,
          &QAbstractButton::setShortcut);
}

LQCheckBox lqcheckbox() {
  return myclass_<QCheckBox, QAbstractButton>("QCheckBox", lqcb_set_map)
      .def(constructor<>())
      .def(constructor<QWidget *>())
      ...
      .class_<QCheckBox, QAbstractButton>::property(
          "checkState", &QCheckBox::checkState, &QCheckBox::setCheckState);
}

LQPushButton lqpushbutton() {
  return myclass_<QPushButton, QAbstractButton>("QPushButton", lqpb_set_map)
      .def(constructor<>())
      .def(constructor<QWidget *>())
      .def(constructor<const QString &>())
      .def(constructor<const QString &, QWidget *>())
      ...
      .property("autoDefault", &QPushButton::autoDefault,
                &QPushButton::setAutoDefault)

      .class_<QPushButton, QAbstractButton>::property(
          "menu", &QPushButton::menu, &QPushButton::setMenu);
}

LQRadioButton lqradionbutton() {
  return myclass_<QRadioButton, QAbstractButton>("QRadioButton", lqrb_set_map)
      .def(constructor<>())
      .def(constructor<QWidget *>())
      .def(constructor<const QString &>())
      .def(constructor<const QString &, QWidget *>())
...
LQToolButton lqtoolbutton() {
  return myclass_<QToolButton, QAbstractButton>("QToolButton", lqtb_set_map)
      .def(constructor<>())
      .def(constructor<QWidget *>())
      .def("__call", lqtb_init)
      .def("__init", table_init_general<QToolButton>)

      .property("autoRaise", &QToolButton::autoRaise,
...
LQButtonGroup lqbuttongroup() {
  return myclass_<QButtonGroup, QObject>("QButtonGroup", lqbg_set_map)
      .def(constructor<>())
      .def(constructor<QWidget *>())
      ...
      .def("addButton",
           (void(QButtonGroup::*)(QAbstractButton *)) & QButtonGroup::addButton)
      .def("addButton", (void(QButtonGroup::*)(QAbstractButton *, int)) &
      ...
      .property("exclusive", &QButtonGroup::exclusive,
                &QButtonGroup::setExclusive);
}

LQKeySequence lqkeysequence() {
  return class_<QKeySequence>("QKeySequence")
      .def(constructor<>())
