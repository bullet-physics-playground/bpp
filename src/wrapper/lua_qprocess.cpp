...
LQProcessEnvironment lqprocessenvironment() {
  return class_<QProcessEnvironment>("QProcessEnvironment")
      ...
      .scope[def("systemEnvironment", &QProcessEnvironment::systemEnvironment)];
}
...
template <>
void table_init_general<QProcess>(const luabind::argument &arg,
                                  const object &obj) {
...
qint64 lqprocess_pid(QProcess *w) { return (qint64)w->pid(); }

LQProcess lqprocess() {
  return myclass_<QProcess, QObject>("QProcess", lqprocess_set_map)
      .def(constructor<>())
      ...
      .def("readLine",
           tag_function<QByteArray(QProcess *)>(boost::bind(
               (QByteArray(QProcess::*)(qint64)) & QProcess::readLine, _1, 0)))
      .def("getChar", lqprocess_getchar)
      .def("setStandardErrorFile", &QProcess::setStandardErrorFile)
      .def("setStandardErrorFile",
           tag_function<void(QProcess *, const QString &)>(boost::bind(
               &QProcess::setStandardErrorFile, _1, _2, QIODevice::Truncate)))
      .def("setStandardOutputFile", &QProcess::setStandardOutputFile)
      .def("setStandardOutputFile",
           tag_function<void(QProcess *, const QString &)>(boost::bind(
               &QProcess::setStandardOutputFile, _1, _2, QIODevice::Truncate)))
      .def("setStandardInputFile", &QProcess::setStandardInputFile)
      .def("setStandardOutputProcess", &QProcess::setStandardOutputProcess)
      .def("start", (void(QProcess::*)(const QString &, const QStringList &,
                                       QIODevice::OpenMode)) &
                        QProcess::start)
      .def("start",
           tag_function<void(QProcess *, const QString &, const QStringList &)>(
               boost::bind(
                   (void(QProcess::*)(const QString &, const QStringList &,
                                      QIODevice::OpenMode)) &
                       QProcess::start,
                   _1, _2, _3, QIODevice::ReadWrite)))
      .def("start", (void(QProcess::*)(const QString &, QIODevice::OpenMode)) &
                        QProcess::start)
      .def("start",
           tag_function<void(QProcess *, const QString &)>(boost::bind(
               (void(QProcess::*)(const QString &, QIODevice::OpenMode)) &
                   QProcess::start,
               _1, _2, QIODevice::ReadWrite)))
      .def("waitForFinished", &QProcess::waitForFinished)
      .def("waitForFinished", tag_function<bool(QProcess *)>(boost::bind(
                                  &QProcess::waitForFinished, _1, 30000)))
      .def("waitForStarted", &QProcess::waitForStarted)
      .def("waitForStarted", tag_function<bool(QProcess *)>(boost::bind(
                                 &QProcess::waitForStarted, _1, 30000)))
      .def("waitForBytesWritten", &QProcess::waitForBytesWritten)
      .def("waitForBytesWritten",
           tag_function<bool(QProcess *)>(
               boost::bind(&QProcess::waitForBytesWritten, _1, 30000)))
      .def("waitForReadyRead", &QProcess::waitForReadyRead)
      .def("waitForReadyRead", tag_function<bool(QProcess *)>(boost::bind(
                                   &QProcess::waitForReadyRead, _1, 30000)))
      ...
      .property("processChannelMode", QProcess_processChannelMode,
                QProcess_setProcessChannelMode)
      .property("readChannel", QProcess_readChannel, QProcess_setReadChannel)
      .property("readChannelMode", QProcess_readChannelMode,
                QProcess_setReadChannelMode)
      .property("workingDirectory", &QProcess::workingDirectory,
                &QProcess::setWorkingDirectory)
      .class_<QProcess, QObject>::property(
          "environment", &QProcess::environment, &QProcess::setEnvironment)
      .property("environment", &QProcess::processEnvironment,
                &QProcess::setProcessEnvironment)
      .property("error",
                (QProcess::ProcessError(QProcess::*)() const) & QProcess::error)
...
// void lqapplication_table_init(const luabind::argument & arg, const object&
// obj)
//{
...
SIGNAL_PROPERYT(lqapplication, focusChanged, QApplication,
                "(QWidget*,QWidget*)")
...
QApplication *lqapplication_instance() { return qApp; }
LQApplication lqapplication() {
  return myclass_<QApplication, QObject>("QApplication", lqapplication_set_map)
      ...
      .property("autoSipEnabled", &QApplication::autoSipEnabled,
                &QApplication::setAutoSipEnabled)
      .property("cursorFlashTime", &QApplication::cursorFlashTime,
                &QApplication::setCursorFlashTime)
      .property("doubleClickInterval", &QApplication::doubleClickInterval,
                &QApplication::setDoubleClickInterval)
      .property("globalStrut", &QApplication::globalStrut,
                &QApplication::setGlobalStrut)
      .property("keyboardInputInterval", &QApplication::keyboardInputInterval,
                &QApplication::setKeyboardInputInterval)
      .property("layoutDirection", QApplication_layoutDirection,
                QApplication_setLayoutDirection)
      .property("quitOnLastWindowClosed", &QApplication::quitOnLastWindowClosed,
                &QApplication::setQuitOnLastWindowClosed)
      .property("startDragTime", &QApplication::startDragTime,
                &QApplication::setStartDragTime)
      .property("startDragTime", &QApplication::startDragDistance,
                &QApplication::setStartDragDistance)
      .property("styleSheet", &QApplication::styleSheet,
                &QApplication::setStyleSheet)
      .property("wheelScrollLines", &QApplication::wheelScrollLines,
                &QApplication::setWheelScrollLines)
      .property("windowIcon", &QApplication::windowIcon,
      ...
      .scope[def("arguments", &QApplication::arguments),
...
const QRect lqdesktopwidget_availableGeometry(QDesktopWidget *w) {
  return w->availableGeometry();
}
QWidget *lqdesktopwidget_screen(QDesktopWidget *w) { return w->screen(); }
const QRect lqdesktopwidget_screenGeometry(QDesktopWidget *w) {
  return w->screenGeometry();
}
int lqdesktopwidget_screenNumber(QDesktopWidget *w) {
  return w->screenNumber();
}
...
LQDesktopWidget lqdesktopwidget() {
  return class_<QDesktopWidget, QWidget>("QDesktopWidget")
      .def("availableGeometry", lqdesktopwidget_availableGeometry)
      .def("availableGeometry", (const QRect (QDesktopWidget::*)(int) const) &
                                    QDesktopWidget::availableGeometry)
      .def("availableGeometry",
           (const QRect (QDesktopWidget::*)(const QWidget *) const) &
               QDesktopWidget::availableGeometry)
      .def("availableGeometry",
           (const QRect (QDesktopWidget::*)(const QPoint &) const) &
               QDesktopWidget::availableGeometry)
      .def("screen", lqdesktopwidget_screen)
      .def("screen", &QDesktopWidget::screen)
      .def("screenGeometry", lqdesktopwidget_screenGeometry)
      .def("screenGeometry", (const QRect (QDesktopWidget::*)(int) const) &
      ...
      .def("screenNumber", (int(QDesktopWidget::*)(const QWidget *) const) &
                               QDesktopWidget::screenNumber)
      .def("screenNumber", (int(QDesktopWidget::*)(const QPoint &) const) &
                               QDesktopWidget::screenNumber)
...
LQClipboard lqclipboard() {
  return class_<QClipboard, QObject>("QClipboard")
      .def("clear", &QClipboard::clear)
      .def("clear", tag_function<void(QClipboard *)>(boost::bind(
                        &QClipboard::clear, _1, QClipboard::Clipboard)))
      .def("image", &QClipboard::image)
      .def("image", tag_function<QImage(QClipboard *)>(boost::bind(
                        &QClipboard::image, _1, QClipboard::Clipboard)))
      .def("mimeData", &QClipboard::mimeData)
      .def("mimeData",
           tag_function<const QMimeData *(QClipboard *)>(
               boost::bind(&QClipboard::mimeData, _1, QClipboard::Clipboard)))
      .def("pixmap", &QClipboard::pixmap)
      .def("pixmap", tag_function<QPixmap(QClipboard *)>(boost::bind(
                         &QClipboard::pixmap, _1, QClipboard::Clipboard)))
      .def("setImage", &QClipboard::setImage)
      .def("setImage",
           tag_function<void(QClipboard *, const QImage &)>(boost::bind(
               &QClipboard::setImage, _1, _2, QClipboard::Clipboard)))
      .def("setMimeData", &QClipboard::setMimeData)
      .def("setMimeData",
           tag_function<void(QClipboard *, QMimeData *)>(boost::bind(
               &QClipboard::setMimeData, _1, _2, QClipboard::Clipboard)))
      .def("setPixmap", &QClipboard::setPixmap)
      .def("setPixmap",
           tag_function<void(QClipboard *, const QPixmap &)>(boost::bind(
               &QClipboard::setPixmap, _1, _2, QClipboard::Clipboard)))
      .def("setText", &QClipboard::setText)
      .def("setText",
           tag_function<void(QClipboard *, const QString &)>(boost::bind(
               &QClipboard::setText, _1, _2, QClipboard::Clipboard)))
      .def("text",
           (QString(QClipboard::*)(QClipboard::Mode) const) & QClipboard::text)
      .def("text", tag_function<QString(QClipboard *)>(boost::bind(
                       (QString(QClipboard::*)(QClipboard::Mode) const) &
                           QClipboard::text,
                       _1, QClipboard::Clipboard)))
      .def("text", (QString(QClipboard::*)(QString &, QClipboard::Mode) const) &
                       QClipboard::text)
      .def("text",
           tag_function<QString(QClipboard *, QString &)>(boost::bind(
               (QString(QClipboard::*)(QString &, QClipboard::Mode) const) &
                   QClipboard::text,
               _1, _2, QClipboard::Clipboard)))
...
LQSound lqsound() {
  return class_<QSound, QObject>("QSound")
      ...
      .scope[def("isAvailable", &QSound::isAvailable),
             def("play", (void (*)(const QString &)) & QSound::play)];
}

SIGNAL_PROPERYT(lqfilesystemwatcher, directoryChanged, QFileSystemWatcher,
                "(const QString&)")
SIGNAL_PROPERYT(lqfilesystemwatcher, fileChanged, QFileSystemWatcher,
                "(const QString&)")
LQFileSystemWatcher lqfilesystemwatcher() {
  return class_<QFileSystemWatcher, QObject>("QFileSystemWatcher")
      .def(constructor<>())
      .def(constructor<QObject *>())
