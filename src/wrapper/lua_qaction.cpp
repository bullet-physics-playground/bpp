  ...
  if (type(table) == LUA_TTABLE) {
    for (iterator i(table), e; i != e; ++i) {
      ...
      if (type(*i) == LUA_TUSERDATA) {
        if (q_cast(*i, (void(QAction::*)(const QIcon &)) & QAction::setIcon,
                   widget)) {
        } else if (q_cast(*i, &QAction::setShortcut, widget)) {
        } else if (q_cast(*i, &QAction::setMenu, widget)) {
        }
      } /*else if(type(*i)== LUA_TSTRING){
           if(q_cast(*i, (QAction*(QToolBar::*)(const
       QString&))&QToolBar::addAction, widget)){
           }
       }*/
...
LQAction lqaction() {
  return myclass_<QAction, QObject>("QAction", lqaction_set_map)
      ...
      .property("iconVisibleInMenu", &QAction::isIconVisibleInMenu,
      ...
      .class_<QAction, QObject>::property("shortcut", &QAction::shortcut,
                                          &QAction::setShortcut)
      .property("shortcuts", &QAction::shortcuts,
                (void(QAction::*)(const QList<QKeySequence> &)) &
...
QMenuBar *lqmenubar_init(QMenuBar *widget, const object &table) {
  if (type(table) == LUA_TTABLE) {
    for (iterator i(table), e; i != e; ++i) {
      if (type(*i) == LUA_TUSERDATA) {
        if (q_cast(*i, (void(QMenuBar::*)(QAction *)) & QMenuBar::addAction,
                   widget)) {
        ...
        if (q_cast(*i,
                   (QMenu * (QMenuBar::*)(const QString &)) & QMenuBar::addMenu,
                   widget)) {
        }
...
LQMenuBar lqmenubar() {
  return myclass_<QMenuBar, QWidget>("QMenuBar", lqmenubar_set_map)
      .def(constructor<>())
      .def("addMenu", (QAction * (QMenuBar::*)(QMenu *)) & QMenuBar::addMenu)
      .def("addMenu",
           (QMenu * (QMenuBar::*)(const QString &)) & QMenuBar::addMenu)
      .def("addAction",
           (void(QMenuBar::*)(QAction * action)) & QMenuBar::addAction)
      .def("addAction",
           (QAction * (QMenuBar::*)(const QString &)) & QMenuBar::addAction)

      .def("insertMenu",
           (QAction * (QMenuBar::*)(QAction *, QMenu *)) & QMenuBar::insertMenu)
      .def("insertMenu",
           (QAction * (*)(QMenuBar *, int, QMenu *)) & lqmenubar_insert_menu)
      .def("insertMenu", (QMenu * (*)(QMenuBar *, int, const QString &)) &
                             lqmenubar_insert_menu)
      ...
      .property("nativeMenuBar", &QMenuBar::isNativeMenuBar,
                &QMenuBar::setNativeMenuBar)
      //.class_<QMenuBar,QWidget>::property("defaultAction",
      //&QMenuBar::defaultAction, &QMenuBar::setDefaultAction)
      ;
}
...
QMenu *lqmenu_init(QMenu *widget, const object &table) {
  ...
  if (type(table) == LUA_TTABLE) {
    for (iterator i(table), e; i != e; ++i) {
      if (type(*i) == LUA_TUSERDATA) {
        if (q_cast(*i, (void(QMenu::*)(QAction *)) & QMenu::addAction,
                   widget)) {
          QAction *act = object_cast<QAction *>(*i);
          act->setParent(widget);
        } else if (q_cast(*i, (QAction * (QMenu::*)(QMenu *)) & QMenu::addMenu,
                          widget)) {
          // QMenu* act = object_cast<QMenu*>(*i);
          // act->setParent(widget);
        }
        ...
        if (q_cast(*i,
                   (QAction * (QMenu::*)(const QString &)) & QMenu::addAction,
                   widget)) {
        }
      }
      // qDebug()<<"key:"<<toString(i.key())<<"val:"<<toString(*i);
...
LQMenu lqmenu() {
  return myclass_<QMenu, QWidget>("QMenu", lqmenu_set_map)
      .def(constructor<>())
      ...
      .def("addAction",
           (QAction * (QMenu::*)(const QString &)) & QMenu::addAction)
      .def("addAction", (QAction * (QMenu::*)(const QIcon &, const QString &)) &
                            QMenu::addAction)
      ...
      .def("addMenu", (QMenu * (QMenu::*)(const QIcon &, const QString &)) &
                          QMenu::addMenu)
      .def("addSeparator", &QMenu::addSeparator)
      .def("exec", (QAction * (QMenu::*)()) & QMenu::exec)
      .def("exec",
           (QAction * (QMenu::*)(const QPoint &, QAction *)) & QMenu::exec)
      .def("exec",
           tag_function<QAction *(QMenu *, const QPoint &)>(boost::bind(
               (QAction * (QMenu::*)(const QPoint &, QAction *)) & QMenu::exec,
               _1, _2, (QAction *)0)))
      ...
      .def("popup", tag_function<void(QMenu *, const QPoint &)>(
                        boost::bind(&QMenu::popup, _1, _2, (QAction *)0)))
      ...
      .class_<QMenu, QWidget>::property("activeAction", &QMenu::activeAction,
                                        &QMenu::setActiveAction)
      .property("defaultAction", &QMenu::defaultAction,
                &QMenu::setDefaultAction)

      .scope[def("exec", (QAction * (*)(QList<QAction *>, const QPoint &,
                                        QAction *, QWidget *)) &
                             QMenu::exec),
             def("exec",
                 (QAction * (*)(QList<QAction *>, const QPoint &, QAction *)) &
                     QMenu::exec),
             def("exec",
                 tag_function<QAction *(QList<QAction *>, const QPoint &)>(
                     boost::bind((QAction * (*)(QList<QAction *>,
...
QToolBar *lqtoolbar_init(QToolBar *widget, const object &table) {
  if (type(table) == LUA_TTABLE) {
    for (iterator i(table), e; i != e; ++i) {
      if (type(*i) == LUA_TUSERDATA) {
        if (q_cast(*i, (void(QToolBar::*)(QAction *)) & QToolBar::addAction,
                   widget)) {
          QAction *act = object_cast<QAction *>(*i);
          act->setParent(widget);
        }
        ...
        if (q_cast(*i,
                   (QAction * (QToolBar::*)(const QString &)) &
                       QToolBar::addAction,
                   widget)) {
        }
      }
...
SIGNAL_PROPERYT(lqtoolbar, toolButtonStyleChanged, QToolBar,
                "(Qt::ToolButtonStyle)")
SIGNAL_PROPERYT(lqtoolbar, topLevelChanged, QToolBar, "(bool)")

LQToolBar lqtoolbar() {
  return class_<QToolBar, QWidget>("QToolBar")
      .def(constructor<>())
      .def(constructor<const QString &>())
      .def("addAction", (void(QToolBar::*)(QAction *)) & QToolBar::addAction)
      .def("addAction",
           (QAction * (QToolBar::*)(const QString &)) & QToolBar::addAction)
      .def("addAction",
           (QAction * (QToolBar::*)(const QIcon &, const QString &)) &
               QToolBar::addAction)
      ...
      .property("allowedAreas", &QToolBar::allowedAreas,
      ...
      .property("allowedAreas", &QToolBar::allowedAreas,
                &QToolBar::setAllowedAreas)
      .property("orientation", &QToolBar::orientation,
                &QToolBar::setOrientation)
      .property("toolButtonStyle", &QToolBar::toolButtonStyle,
...
#define _R                                                                     \
  (void(QIcon::*)(QPainter *, const QRect &, Qt::Alignment, QIcon::Mode,       \
                  QIcon::State) const)
#define _RI                                                                    \
  (void(QIcon::*)(QPainter *, int, int, int, int, Qt::Alignment, QIcon::Mode,  \
                  QIcon::State) const)
...
LQIcon lqicon() {
  return class_<QIcon>("QIcon")
      .def(constructor<>())
      .def(constructor<const QIcon &>())
      .def(constructor<const QString &>())
      .def("actualSize", &QIcon::actualSize)
      .def("actualSize",
           tag_function<QSize(QIcon *, const QSize &, QIcon::Mode)>(
               boost::bind(&QIcon::actualSize, _1, _2, _3, QIcon::Off)))
      .def("actualSize",
           tag_function<QSize(QIcon *, const QSize &)>(boost::bind(
               &QIcon::actualSize, _1, _2, QIcon::Normal, QIcon::Off)))
      .def("addFile", &QIcon::addFile)
      .def("addFile",
           tag_function<void(QIcon *, const QString &, const QSize &,
                             QIcon::Mode)>(
               boost::bind(&QIcon::addFile, _1, _2, _3, _4, QIcon::Off)))
      .def("addFile",
           tag_function<void(QIcon *, const QString &, const QSize &)>(
               boost::bind(&QIcon::addFile, _1, _2, _3, QIcon::Normal,
                           QIcon::Off)))
      .def("addFile",
           tag_function<void(QIcon *, const QString &)>(boost::bind(
               &QIcon::addFile, _1, _2, QSize(), QIcon::Normal, QIcon::Off)))
      .def("addPixmap", &QIcon::addPixmap)
      .def("addPixmap",
           tag_function<void(QIcon *, const QPixmap &, QIcon::Mode)>(
               boost::bind(&QIcon::addPixmap, _1, _2, _3, QIcon::Off)))
      .def("addPixmap",
           tag_function<void(QIcon *, const QPixmap &)>(boost::bind(
               &QIcon::addPixmap, _1, _2, QIcon::Normal, QIcon::Off)))
      .def("availableSizes", &QIcon::availableSizes)
      .def("availableSizes",
           tag_function<QList<QSize>(QIcon *, QIcon::Mode)>(
               boost::bind(&QIcon::availableSizes, _1, _2, QIcon::Off)))
      .def("availableSizes",
           tag_function<QList<QSize>(QIcon *)>(boost::bind(
               &QIcon::availableSizes, _1, QIcon::Normal, QIcon::Off)))
      ...
      .def("pixmap",
           tag_function<QPixmap(QIcon *, const QSize &, QIcon::Mode)>(
               boost::bind(_m1 & QIcon::pixmap, _1, _2, _3, QIcon::Off)))
      .def("pixmap",
           tag_function<QPixmap(QIcon *, const QSize &)>(boost::bind(
               _m1 & QIcon::pixmap, _1, _2, QIcon::Normal, QIcon::Off)))

      .def("pixmap", _m2 & QIcon::pixmap)
      .def("pixmap",
           tag_function<QPixmap(QIcon *, int, int, QIcon::Mode)>(
               boost::bind(_m2 & QIcon::pixmap, _1, _2, _3, _4, QIcon::Off)))
      .def("pixmap",
           tag_function<QPixmap(QIcon *, int, int)>(boost::bind(
               _m2 & QIcon::pixmap, _1, _2, _3, QIcon::Normal, QIcon::Off)))

      .def("pixmap", _m3 & QIcon::pixmap)
      .def("pixmap",
           tag_function<QPixmap(QIcon *, int)>(boost::bind(
               _m3 & QIcon::pixmap, _1, _2, QIcon::Normal, QIcon::Off)))

      .def("paint", _R & QIcon::paint)
      .def("paint", _RI & QIcon::paint)
      .def("paint", tag_function<_F(_p, _r)>(boost::bind(
                        _R & QIcon::paint, _1, _2, _3, Qt::AlignCenter,
                        QIcon::Normal, QIcon::Off)))
      .def("paint",
           tag_function<_F(_p, _r, Qt::Alignment)>(boost::bind(
               _R & QIcon::paint, _1, _2, _3, _4, QIcon::Normal, QIcon::Off)))
      .def("paint",
           tag_function<_F(_p, _r, Qt::Alignment, QIcon::Mode)>(
               boost::bind(_R & QIcon::paint, _1, _2, _3, _4, _5, QIcon::Off)))
      .def("paint", tag_function<_F(_p, _ri)>(boost::bind(
                        _RI & QIcon::paint, _1, _2, _3, _4, _5, _6,
                        Qt::AlignCenter, QIcon::Normal, QIcon::Off)))
      .def("paint", tag_function<_F(_p, _ri, Qt::Alignment)>(
                        boost::bind(_RI & QIcon::paint, _1, _2, _3, _4, _5, _6,
                                    _7, QIcon::Normal, QIcon::Off)))
      .def("paint",
           tag_function<_F(_p, _ri, Qt::Alignment, QIcon::Mode)>(boost::bind(
               _RI & QIcon::paint, _1, _2, _3, _4, _5, _6, _7, _8, QIcon::Off)))
      .scope[def("fromTheme", &QIcon::fromTheme)];
}
namespace luabind {
QT_ENUM_CONVERTER(Qt::CursorShape)
}
LQCursor lqcursor() {
  return class_<QCursor>("QCursor")
