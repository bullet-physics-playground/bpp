...
template <>
void table_init_general<QDialog>(const luabind::argument &arg,
                                 const object &obj) {
...
template <>
void table_init_general<QFrame>(const luabind::argument &arg,
                                const object &obj) {
...
template <>
void table_init_general<QGroupBox>(const luabind::argument &arg,
                                   const object &obj) {
...
LQDialog lqdialog() {
  return myclass_<QDialog, QWidget>("QDialog", lqdialog_set_map)
      .def(constructor<>())
      ...
      .property("sizeGripEnabled", &QDialog::isSizeGripEnabled,
...
LQFrame lqframe() {
  return class_<QFrame, QWidget>("QFrame")
      .def(constructor<>())
      .def(constructor<QWidget *>())
      .def(constructor<QWidget *, Qt::WindowFlags>())
...
LQGroupBox lqgroupbox() {
  return myclass_<QGroupBox, QWidget>("QGroupBox", lqgroupbox_set_map)
      .def(constructor<>())
      .def(constructor<QWidget *>())
...
template <>
void table_init_general<QSplitter>(const luabind::argument &arg,
                                   const object &obj) {
...
void lqsplitter_setOpaqueResize(QSplitter *w) { w->setOpaqueResize(); }
...
LQSplitter lqsplitter() {
  return myclass_<QSplitter, QFrame>("QSplitter", lqsplitter_set_map)
      .def(constructor<>())
      .def(constructor<QWidget *>())
      ...
      .property("childrenCollapsible", &QSplitter::childrenCollapsible,
                &QSplitter::setChildrenCollapsible)
      .property("count", &QSplitter::count)
      .property("handleWidth", &QSplitter::handleWidth,
      ...
      .property("opaqueResize", &QSplitter::opaqueResize,
                &QSplitter::setOpaqueResize)
      .sig_prop(lqsplitter, splitterMoved)
      .class_<QSplitter, QFrame>::property("sizes", &QSplitter::sizes,
                                           &QSplitter::setSizes);
}
