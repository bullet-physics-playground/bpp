    ...
    if (type(i.key()) == LUA_TSTRING && type(*i) == LUA_TUSERDATA) {
      ...
      try {
        if (k.compare("leftcorner", Qt::CaseInsensitive) == 0) {
          widget->setCornerWidget(object_cast<QWidget *>(*i),
                                  Qt::TopLeftCorner);
...
template <>
void table_init_general<QTabWidget>(const luabind::argument &arg,
                                    const object &obj) {
...
LQTabWidget lqtabwidget() {
  return myclass_<QTabWidget, QWidget>("QTabWidget", lqtabwidget_set_map)
      .def(constructor<>())
      .def(constructor<QWidget *>())
      .def("__init", table_init_general<QTabWidget>)
      .def("__call", lqtabwidget_init)
      .def("addTab", (int(QTabWidget::*)(QWidget *, const QString &)) &
                         QTabWidget::addTab)
      .def("addTab",
           (int(QTabWidget::*)(QWidget *, const QIcon &, const QString &)) &
               QTabWidget::addTab)
      .def("clear", &QTabWidget::clear)
      .def("cornerWidget", &QTabWidget::cornerWidget)
      .def("cornerWidget",
           tag_function<QWidget *(QTabWidget *)>(
               boost::bind(&QTabWidget::cornerWidget, _1, Qt::TopRightCorner)))
      ...
      .def("insertTab", (int(QTabWidget::*)(int, QWidget *, const QString &)) &
                            QTabWidget::insertTab)
      .def("insertTab", (int(QTabWidget::*)(int, QWidget *, const QIcon &,
                                            const QString &)) &
                            QTabWidget::insertTab)
      .def("removeTab", &QTabWidget::removeTab)
      .def("setCornerWidget", &QTabWidget::setCornerWidget)
      .def("setCornerWidget",
           tag_function<void(QTabWidget *, QWidget *)>(boost::bind(
               &QTabWidget::setCornerWidget, _1, _2, Qt::TopRightCorner)))
      .def("widget", &QTabWidget::widget)

      .property("documentMode", &QTabWidget::documentMode,
      ...
      .property("tabEnabled", &QTabWidget::isTabEnabled,
                &QTabWidget::setTabEnabled)
      .property("tabIcon", &QTabWidget::tabIcon, &QTabWidget::setTabIcon)
      .property("tabPosition", &QTabWidget::tabPosition,
                lqtabwidget_setTabPosition)
      .property("tabShape", &QTabWidget::tabShape, lqtabwidget_setTabShape)
      .property("tabsClosable", &QTabWidget::tabsClosable,
                &QTabWidget::setTabsClosable)
      .property("tabText", &QTabWidget::tabText, &QTabWidget::setTabText)
      .property("tabToolTip", &QTabWidget::tabToolTip,
                &QTabWidget::setTabToolTip)
      .property("tabWhatsThis", &QTabWidget::tabWhatsThis,
                &QTabWidget::setTabWhatsThis)
      .property("usesScrollButtons", &QTabWidget::usesScrollButtons,
      ...
      .property("currentIndex", &QTabWidget::currentIndex,
                &QTabWidget::setCurrentIndex)
      .property("currentWidget", &QTabWidget::currentWidget,
                &QTabWidget::setCurrentWidget)
      .property("topLeftCorner",
                tag_function<QWidget *(QTabWidget *)>(boost::bind(
                    &QTabWidget::cornerWidget, _1, Qt::TopLeftCorner)),
                tag_function<void(QTabWidget *, QWidget *)>(boost::bind(
                    &QTabWidget::setCornerWidget, _1, _2, Qt::TopLeftCorner)))
      .property("topRightCorner",
                tag_function<QWidget *(QTabWidget *)>(boost::bind(
                    &QTabWidget::cornerWidget, _1, Qt::TopRightCorner)),
                tag_function<void(QTabWidget *, QWidget *)>(boost::bind(
                    &QTabWidget::setCornerWidget, _1, _2, Qt::TopRightCorner)))
      .property(
          "bottomLeftCorner",
          tag_function<QWidget *(QTabWidget *)>(
              boost::bind(&QTabWidget::cornerWidget, _1, Qt::BottomLeftCorner)),
          tag_function<void(QTabWidget *, QWidget *)>(boost::bind(
              &QTabWidget::setCornerWidget, _1, _2, Qt::BottomLeftCorner)))
      .property(
          "bottomRightCorner",
          tag_function<QWidget *(QTabWidget *)>(boost::bind(
              &QTabWidget::cornerWidget, _1, Qt::BottomRightCorner)),
          tag_function<void(QTabWidget *, QWidget *)>(boost::bind(
              &QTabWidget::setCornerWidget, _1, _2, Qt::BottomRightCorner)))
      .property("leftCorner",
                tag_function<QWidget *(QTabWidget *)>(boost::bind(
                    &QTabWidget::cornerWidget, _1, Qt::TopLeftCorner)),
                tag_function<void(QTabWidget *, QWidget *)>(boost::bind(
...
template <>
void table_init_general<QToolBox>(const luabind::argument &arg,
                                  const object &obj) {
  lqtoolbox_init(construct<QToolBox>(arg), obj);
}

LQToolBox lqtoolbox() {
  return myclass_<QToolBox, QFrame>("QToolBox", lqtoolbox_set_map)
      .def(constructor<>())
      .def(constructor<QWidget *>())
      .def("__init", table_init_general<QToolBox>)
      .def("__call", lqtoolbox_init)
      .def("addItem",
           (int(QToolBox::*)(QWidget *, const QString &)) & QToolBox::addItem)
      .def("addItem",
           (int(QToolBox::*)(QWidget *, const QIcon &, const QString &)) &
               QToolBox::addItem)
      .def("setCurrentIndex", &QToolBox::setCurrentIndex)
      .def("setCurrentWidget", &QToolBox::setCurrentWidget)
      .def("indexOf", &QToolBox::indexOf)
      .def("insertItem",
           (int(QToolBox::*)(int, QWidget *, const QIcon &, const QString &)) &
               QToolBox::insertItem)
      .def("insertItem", (int(QToolBox::*)(int, QWidget *, const QString &)) &
                             QToolBox::insertItem)

      .def("removeItem", &QToolBox::removeItem)
      .def("widget", &QToolBox::widget)

      .property("itemEnabled", &QToolBox::isItemEnabled,
