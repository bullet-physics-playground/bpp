...
QAbstractSpinBox *lqabstractspinbox_init(QAbstractSpinBox *widget,
                                         const object &obj) {
  lqwidget_init(widget, obj);
  return lq_general_init(widget, obj, lqabstractspinbox_set_map);
}
template <>
void table_init_general<QAbstractSpinBox>(const luabind::argument &arg,
                                          const object &obj) {
...
LQAbstractSpinBox lqabstractspinbox() {
  return myclass_<QAbstractSpinBox, QWidget>("QAbstractSpinBox",
                                             lqabstractspinbox_set_map)
      .def(constructor<>())
      ...
      .property("alignment", QAbstractSpinBox_alignment,
                QAbstractSpinBox_setAlignment)
      .property("buttonSymbols", QAbstractSpinBox_buttonSymbols,
                QAbstractSpinBox_setButtonSymbols)
      .property("correctionMode", QAbstractSpinBox_correctionMode,
                QAbstractSpinBox_setCorrectionMode)
      .property("frame", &QAbstractSpinBox::hasFrame,
                &QAbstractSpinBox::setFrame)
      .property("readOnly", &QAbstractSpinBox::isReadOnly,
                &QAbstractSpinBox::setReadOnly)
      .property("accelerated", &QAbstractSpinBox::isAccelerated,
                &QAbstractSpinBox::setAccelerated)
      .property("keyboardTracking", &QAbstractSpinBox::keyboardTracking,
                &QAbstractSpinBox::setKeyboardTracking)
      .property("wrapping", &QAbstractSpinBox::wrapping,
...
template <>
void table_init_general<QSpinBox>(const luabind::argument &arg,
                                  const object &obj) {
  lqspinbox_init(construct<QSpinBox>(arg), obj);
}
SIGNAL_PROPERYT(lqspinbox, valueChanged, QSpinBox, "(int)")
LQSpinBox lqspinbox() {
  return myclass_<QSpinBox, QAbstractSpinBox>("QSpinBox", lqspinbox_set_map)
      .def(constructor<>())
      .def(constructor<QWidget *>())
...
QDoubleSpinBox *lqdoublespinbox_init(QDoubleSpinBox *widget,
                                     const object &obj) {
  lqabstractspinbox_init(widget, obj);
  return lq_general_init(widget, obj, lqdoublespinbox_set_map);
}
template <>
void table_init_general<QDoubleSpinBox>(const luabind::argument &arg,
                                        const object &obj) {
...
LQDoubleSpinBox lqdoublespinbox() {
  return myclass_<QDoubleSpinBox, QAbstractSpinBox>("QDoubleSpinBox",
                                                    lqdoublespinbox_set_map)
      .def(constructor<>())
      .def(constructor<QWidget *>())
      ...
      .property("decimals", &QDoubleSpinBox::decimals,
                &QDoubleSpinBox::setDecimals)
      .property("maximum", &QDoubleSpinBox::maximum,
                &QDoubleSpinBox::setMaximum)
      .property("minimum", &QDoubleSpinBox::minimum,
      ...
      .property("singleStep", &QDoubleSpinBox::singleStep,
...
LQDate lqdate() {
  ...
  return class_<QDate>("QDate")
      ...
      .def("toString",
           (QString(QDate::*)(const QString &) const) & QDate::toString)
      .def("toString",
           (QString(QDate::*)(Qt::DateFormat) const) & QDate::toString)
      .def("toString",
           tag_function<QString(QDate *)>(boost::bind(
               (QString(QDate::*)(Qt::DateFormat) const) & QDate::toString, _1,
               Qt::TextDate)))
      .def("__tostring",
           tag_function<QString(QDate *)>(boost::bind(
               (QString(QDate::*)(Qt::DateFormat) const) & QDate::toString, _1,
               Qt::TextDate)))
      .scope[def("currentDate", &QDate::currentDate),
             def("isLeapYear", &QDate::isLeapYear),
             def("isValid", (bool (*)(int, int, int)) & QDate::isValid),
             def("fromJulianDay", &QDate::fromJulianDay),
             def("fromString", (QDate(*)(const QString &, const QString &)) &
                                   QDate::fromString),
             def("fromString", (QDate(*)(const QString &, Qt::DateFormat)) &
                                   QDate::fromString),
             def("fromString", tag_function<QDate(const QString &)>(boost::bind(
                                   (QDate(*)(const QString &, Qt::DateFormat)) &
                                       QDate::fromString,
                                   _1, Qt::TextDate))),
...
LQTime lqtime() {
  return class_<QTime>("QTime")
      ...
      .def("setHMS", tag_function<void(QTime *, int, int, int)>(
                         boost::bind(&QTime::setHMS, _1, _2, _3, _4, 0)))
      .def("toString",
           (QString(QTime::*)(const QString &) const) & QTime::toString)
      .def("toString",
           (QString(QTime::*)(Qt::DateFormat) const) & QTime::toString)
      .def("toString",
           tag_function<QString(QTime *)>(boost::bind(
               (QString(QTime::*)(Qt::DateFormat) const) & QTime::toString, _1,
               Qt::TextDate)))
      .def("__tostring",
           tag_function<QString(QTime *)>(boost::bind(
               (QString(QTime::*)(Qt::DateFormat) const) & QTime::toString, _1,
               Qt::TextDate)))
      .scope[def("currentTime", &QTime::currentTime),
             def("isValid", (bool (*)(int, int, int, int)) & QTime::isValid),
             def("isValid", tag_function<bool(int, int, int)>(boost::bind(
                                (bool (*)(int, int, int, int)) & QTime::isValid,
                                _1, _2, _3, 0))),
             def("currentTime", (QTime(*)(const QString &, const QString &)) &
                                    QTime::fromString),
             def("currentTime", (QTime(*)(const QString &, Qt::DateFormat)) &
                                    QTime::fromString),
             def("currentTime",
                 tag_function<QTime(const QString &)>(
                     boost::bind((QTime(*)(const QString &, Qt::DateFormat)) &
                                     QTime::fromString,
                                 _1, Qt::TextDate))),
             def("fromString", (QTime(*)(const QString &, const QString &)) &
                                   QTime::fromString),
             def("fromString", (QTime(*)(const QString &, Qt::DateFormat)) &
                                   QTime::fromString),
             def("fromString", tag_function<QTime(const QString &)>(boost::bind(
                                   (QTime(*)(const QString &, Qt::DateFormat)) &
                                       QTime::fromString,
                                   _1, Qt::TextDate)))];
}

LQDateTime lqdatetime() {
  return class_<QDateTime>("QDateTime")
      .def(constructor<>())
      ...
      .def("toString",
           (QString(QDateTime::*)(const QString &) const) & QDateTime::toString)
      .def("toString",
           (QString(QDateTime::*)(Qt::DateFormat) const) & QDateTime::toString)
      .def("toString", tag_function<QString(QDateTime *)>(boost::bind(
                           (QString(QDateTime::*)(Qt::DateFormat) const) &
                               QDateTime::toString,
                           _1, Qt::TextDate)))
      .def("__tostring", tag_function<QString(QDateTime *)>(boost::bind(
                             (QString(QDateTime::*)(Qt::DateFormat) const) &
                                 QDateTime::toString,
                             _1, Qt::TextDate)))
      ...
      .scope[def("currentDateTime", &QDateTime::currentDateTime),
             def("fromTime_t", &QDateTime::fromTime_t),
             def("fromString",
                 (QDateTime(*)(const QString &, const QString &)) &
                     QDateTime::fromString),
             def("fromString", (QDateTime(*)(const QString &, Qt::DateFormat)) &
                                   QDateTime::fromString),
             def("fromString",
                 tag_function<QDateTime(const QString &)>(boost::bind(
                     (QDateTime(*)(const QString &, Qt::DateFormat)) &
                         QDateTime::fromString,
                     _1, Qt::TextDate)))];
}
...
template <>
void table_init_general<QDateTimeEdit>(const luabind::argument &arg,
                                       const object &obj) {
...
SIGNAL_PROPERYT(lqdatetimeedit, dateTimeChanged, QDateTimeEdit,
                "(const QDateTime&)")
SIGNAL_PROPERYT(lqdatetimeedit, timeChanged, QDateTimeEdit, "(const QTime&)")
LQDateTimeEdit lqdatetimeedit() {
  return myclass_<QDateTimeEdit, QAbstractSpinBox>("QDateTimeEdit",
                                                   lqdatetimeedit_set_map)
      .def(constructor<>())
      .def(constructor<QWidget *>())
      .def(constructor<const QDateTime &>())
      ...
      .property("calendarPopup", &QDateTimeEdit::calendarPopup,
                &QDateTimeEdit::setCalendarPopup)
      .property("currentSection", QDateTimeEdit_currentSection,
                QDateTimeEdit_setCurrentSection)
      .property("currentSectionIndex", &QDateTimeEdit::currentSectionIndex,
                &QDateTimeEdit::setCurrentSectionIndex)

      .property("displayFormat", &QDateTimeEdit::displayFormat,
      ...
      .class_<QDateTimeEdit, QAbstractSpinBox>::property(
      ...
      .property("maximumDate", &QDateTimeEdit::maximumDate,
                &QDateTimeEdit::setMaximumDate)
      .property("minimumDate", &QDateTimeEdit::minimumDate,
      ...
      .property("maxDate", &QDateTimeEdit::maximumDate,
                &QDateTimeEdit::setMaximumDate)
      .property("minDate", &QDateTimeEdit::minimumDate,
                &QDateTimeEdit::setMinimumDate)
      ...
      .property("maximumTime", &QDateTimeEdit::maximumTime,
                &QDateTimeEdit::setMaximumTime)
      .property("minimumTime", &QDateTimeEdit::minimumTime,
      ...
      .property("maxTime", &QDateTimeEdit::maximumTime,
                &QDateTimeEdit::setMaximumTime)
      .property("minTime", &QDateTimeEdit::minimumTime,
                &QDateTimeEdit::setMinimumTime)
      .def("clearMaxTime", &QDateTimeEdit::clearMaximumTime)
      .def("clearMinTime", &QDateTimeEdit::clearMinimumTime)

      .property("dateTime", &QDateTimeEdit::dateTime,
                &QDateTimeEdit::setDateTime)
      .property("maximumDateTime", &QDateTimeEdit::maximumDateTime,
                &QDateTimeEdit::setMaximumDateTime)
      .property("minimumDateTime", &QDateTimeEdit::minimumDateTime,
      ...
      .property("maxDateTime", &QDateTimeEdit::maximumDateTime,
                &QDateTimeEdit::setMaximumDateTime)
      .property("minDateTime", &QDateTimeEdit::minimumDateTime,
                &QDateTimeEdit::setMinimumDateTime)
...
template <>
void table_init_general<QDateEdit>(const luabind::argument &arg,
                                   const object &obj) {
...
template <>
void table_init_general<QTimeEdit>(const luabind::argument &arg,
                                   const object &obj) {
  lqdatetimeedit_init(construct<QTimeEdit>(arg), obj);
}

LQDateEdit lqdateedit() {
  return class_<QDateEdit, QDateTimeEdit>("QDateEdit")
      .def(constructor<>())
      .def(constructor<QWidget *>())
      .def(constructor<const QDate &>())
      .def(constructor<const QDate &, QWidget *>())
...
LQTimeEdit lqtimeedit() {
  return class_<QTimeEdit, QDateTimeEdit>("QTimeEdit")
      .def(constructor<>())
      .def(constructor<QWidget *>())
      .def(constructor<const QTime &>())
      .def(constructor<const QTime &, QWidget *>())
...
template <>
void table_init_general<QTimer>(const luabind::argument &arg,
                                const object &obj) {
...
LQTimer lqtimer() {
  return myclass_<QTimer, QObject>("QTimer", lqtimer_set_map)
      .def(constructor<>())
      ...
      .scope[def("singleShot", lqtimer_singleShot)];
}
