...
struct QLayoutWarp : public QLayout, public luabind::wrap_base {
  ...
  virtual int indexOf(QWidget *widget) const {
    return call_member<int>(this, "indexOf", widget);
  }
  virtual QLayoutItem *itemAt(int index) const {
    return call_member<QLayoutItem *>(this, "itemAt", index);
  }
  virtual QLayoutItem *takeAt(int index) {
    return call_member<QLayoutItem *>(this, "takeAt", index);
  }
  virtual QSize sizeHint() const {
    return call_member<QSize>(this, "sizeHint");
  }
  virtual QSize minimumSize() const {
    return call_member<QSize>(this, "minimumSize");
  }
  virtual QSize maximumSize() const {
    return call_member<QSize>(this, "maximumSize");
  }
  virtual Qt::Orientations expandingDirections() {
    return call_member<Qt::Orientations>(this, "expandingDirections");
  }
  // virtual void setGeometry(const QRect& rect) { call_member<void>(this,
  // "setGeometry", rect); } virtual QRect geometry() const { return
  // call_member<QRect>(this, "geometry"); }
  virtual bool isEmpty() const { return call_member<bool>(this, "isEmpty"); }
  virtual bool hasHeightForWidth() const {
    return call_member<bool>(this, "hasHeightForWidth");
  }
  virtual int heightForWidth(int h) const {
    return call_member<int>(this, "heightForWidth", h);
  }
  virtual int minimumHeightForWidth(int h) const {
    return call_member<int>(this, "minimumHeightForWidth", h);
  }
  ...
  virtual QSpacerItem *spacerItem() {
    return call_member<QSpacerItem *>(this, "spacerItem");
  }
};
...
inline QHBoxLayout *get_pointer(lite_ptr<QHBoxLayout> &l) { return l.get(); }
