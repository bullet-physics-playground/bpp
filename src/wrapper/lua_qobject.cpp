...
QObject *lqobject_get_filter(QObject *obj) { return obj; }
...
void installEventFilter_x(QObject *o, QObject *f) { o->installEventFilter(f); }
...
LQObject lqobject() {
  return class_<QObject, boost::shared_ptr<QObject>>("QObject")
      .def(constructor<>())
...
int lqwidget_actionCount(QWidget *widget) { return widget->actions().count(); }
...
template <typename T> void for_all(const T &t) {
  for (typename T::const_iterator it = t.begin(); it != t.end(); it++) {
    qDebug() << it->first;
  }
}

bool lqwidget_eq(QWidget *l, QWidget *r) { return l == r; }
...
void lqwidget_render2(QWidget *l, QPainter *p, const QPoint &pt) {
  l->render(p, pt);
}
void lqwidget_render3(QWidget *l, QPainter *p, const QPoint &pt,
                      const QRegion &r) {
  l->render(p, pt, r);
}
void lqwidget_render4(QWidget *l, QPainter *p, const QPoint &pt,
                      const QRegion &r, int f) {
  l->render(p, pt, r, QWidget::RenderFlags(f));
}
void lqwidget_render5(QWidget *l, QPixmap *p) { l->render(p); }
void lqwidget_render6(QWidget *l, QPixmap *p, const QPoint &pt) {
  l->render(p, pt);
}
void lqwidget_render7(QWidget *l, QPixmap *p, const QPoint &pt,
                      const QRegion &r) {
  l->render(p, pt, r);
}
void lqwidget_render8(QWidget *l, QPixmap *p, const QPoint &pt,
                      const QRegion &r, int f) {
  l->render(p, pt, r, QWidget::RenderFlags(f));
}
void lqwidget_render9(QWidget *l, QImage *p) { l->render(p); }
void lqwidget_render10(QWidget *l, QImage *p, const QPoint &pt) {
  l->render(p, pt);
}
void lqwidget_render11(QWidget *l, QImage *p, const QPoint &pt,
                       const QRegion &r) {
  l->render(p, pt, r);
}
void lqwidget_render12(QWidget *l, QImage *p, const QPoint &pt,
                       const QRegion &r, int f) {
  l->render(p, pt, r, QWidget::RenderFlags(f));
}
void lqwidget_render13(QWidget *l, QWidget *p) { l->render(p); }
void lqwidget_render14(QWidget *l, QWidget *p, const QPoint &pt) {
  l->render(p, pt);
}
void lqwidget_render15(QWidget *l, QWidget *p, const QPoint &pt,
                       const QRegion &r) {
  l->render(p, pt, r);
}
void lqwidget_render16(QWidget *l, QWidget *p, const QPoint &pt,
                       const QRegion &r, int f) {
  l->render(p, pt, r, QWidget::RenderFlags(f));
}
...
LQWidget lqwidget() {
  return myclass_<QWidget, QObject>("QWidget", lqwidget_set_map)
      .def(constructor<>())
      ...
      .def("setGeometry",
           (void(QWidget::*)(int, int, int, int)) & QWidget::setGeometry)
      ...
      .def("childAt",
           (QWidget * (QWidget::*)(int, int) const) & QWidget::childAt)
      .def("childAt",
           (QWidget * (QWidget::*)(const QPoint &) const) & QWidget::childAt)
      ...
      .def("grabMouse",
           (void(QWidget::*)(const QCursor &)) & QWidget::grabMouse)
      ...
      .def("scroll",
           (void(QWidget::*)(int, int, const QRect &)) & QWidget::scroll)
      .def("setSizeIncrement",
           (void(QWidget::*)(int, int)) & QWidget::setSizeIncrement)
      .def("setSizePolicy",
           (void(QWidget::*)(QSizePolicy::Policy, QSizePolicy::Policy)) &
      ...
      .property("windowIconText", &QWidget::windowIconText,
                &QWidget::setWindowIconText)
      .property("windowFilePath", &QWidget::windowFilePath,
                &QWidget::setWindowFilePath)
      .property("windowFlags", QWidget_windowFlags, QWidget_setWindowFlags)
      .property("windowModality", QWidget_windowModality,
                QWidget_setWindowModality)
      .property("windowOpacity", &QWidget::windowOpacity,
      ...
      .property("windowModified", &QWidget::isWindowModified,
                &QWidget::setWindowModified)
      .property("modified", &QWidget::isWindowModified,
                &QWidget::setWindowModified)
      .property("visible", &QWidget::isVisible, &QWidget::setVisible)
      .property("hidden", &QWidget::isHidden, &QWidget::setHidden)
      .property("mouseTracking", &QWidget::hasMouseTracking,
      ...
      .property("contextMenuPolicy", QWidget_contextMenuPolicy,
                QWidget_setContextMenuPolicy)

      .property("accessibleDescription", &QWidget::accessibleDescription,
                &QWidget::setAccessibleDescription)
      .property("accessibleName", &QWidget::accessibleName,
                &QWidget::setAccessibleName)
      .property("autoFillBackground", &QWidget::autoFillBackground,
                &QWidget::setAutoFillBackground)
      .property("backgroundRole", QWidget_backgroundRole,
                QWidget_setBackgroundRole)
      .property("foregroundRole", QWidget_foregroundRole,
                QWidget_setForegroundRole)
      .property("baseSize", &QWidget::baseSize,
                (void(QWidget::*)(const QSize &)) & QWidget::setBaseSize)
...
#endif
      .property("layoutDirection", QWidget_layoutDirection,
                QWidget_setLayoutDirection)
      .property("updatesEnabled", &QWidget::updatesEnabled,
      ...
      .property("maximumHeight", &QWidget::maximumHeight,
                &QWidget::setMaximumHeight)
      .property("maximumWidth", &QWidget::maximumWidth,
                &QWidget::setMaximumWidth)
      .property("maxHeight", &QWidget::maximumHeight,
                &QWidget::setMaximumHeight)
      ...
      .property("minimumHeight", &QWidget::minimumHeight,
                &QWidget::setMinimumHeight)
      .property("minimumWidth", &QWidget::minimumWidth,
                &QWidget::setMinimumWidth)
      .property("minHeight", &QWidget::minimumHeight,
                &QWidget::setMinimumHeight)
      ...
      .property("geometry", &QWidget::geometry,
                (void(QWidget::*)(const QRect &)) & QWidget::setGeometry)
      ...
      .class_<QWidget, QObject>::property("cursor", &QWidget::cursor,
                                          &QWidget::setCursor)
      .property("focusProxy", &QWidget::focusProxy, &QWidget::setFocusProxy)
      .property("locale", &QWidget::locale, &QWidget::setLocale)
      .property("mask", &QWidget::mask,
                (void(QWidget::*)(const QRegion &)) & QWidget::setMask)
      .property("pos", &QWidget::pos,
                (void(QWidget::*)(const QPoint &)) & QWidget::move)
      .property("rect", &QWidget::rect)
      .property("size", &QWidget::size)
      .property("sizeHint", &QWidget::sizeHint)
      .property("sizeIncrement", &QWidget::sizeIncrement,
                (void(QWidget::*)(const QSize &)) & QWidget::setSizeIncrement)
      .property("sizePolicy", &QWidget::sizePolicy,
                (void(QWidget::*)(QSizePolicy)) & QWidget::setSizePolicy)

      .scope[def("setTabOrder", &QWidget::setTabOrder)];
}
...
QString lqvariant_tostring(QVariant *var) {
  return QString::fromLocal8Bit("QVariant type:") +
         QString::fromLocal8Bit(var->typeName());
}

LQVariant lqvariant() {
  return class_<QVariant>("QVariant")
      .def(constructor<>())
...
#define IS_CLASS(name)                                                         \
  template <> bool is_class<name>(const object &obj) {                         \
    return obj_name_is(obj, #name);                                            \
  }                                                                            \
  template <> bool is_class<name *>(const object &obj) {                       \
    return obj_name_is(obj, #name);                                            \
  }                                                                            \
  template <> bool is_class<const name &>(const object &obj) {                 \
    return obj_name_is(obj, #name);                                            \
  }                                                                            \
  template <> bool is_class<const name *>(const object &obj) {                 \
    return obj_name_is(obj, #name);                                            \
...
#define IS_CLASS2(cls, name)                                                   \
  template <> bool is_class<cls>(const object &obj) {                          \
    return obj_name_is(obj, #name);                                            \
  }                                                                            \
  template <> bool is_class<cls *>(const object &obj) {                        \
    return obj_name_is(obj, #name);                                            \
  }                                                                            \
  template <> bool is_class<const cls &>(const object &obj) {                  \
    return obj_name_is(obj, #name);                                            \
  }                                                                            \
  template <> bool is_class<const cls *>(const object &obj) {                  \
    return obj_name_is(obj, #name);                                            \
...
template <> bool is_class<QString>(const object &obj) {
  return type(obj) == LUA_TSTRING;
}
template <> bool is_class<QWidget *>(const object &obj) {
  return type(obj) == LUA_TUSERDATA;
}
...
template <class T> void make_return(lua_State *L, const T &t) {
