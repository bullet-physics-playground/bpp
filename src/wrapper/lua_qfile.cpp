...
bool lqfile_open(QFile *w) { return w->open(QIODevice::ReadWrite); }

QByteArray lqfile_readLine(QFile *w) { return w->readLine(); }

LQFile lqfile() {
  return class_<QFile, QObject>("QFile")
      ...
      .property("permissions",
                (QFile::Permissions(QFile::*)() const) & QFile::permissions,
                (bool(QFile::*)(QFile::Permissions)) & QFile::setPermissions)

      .scope[def("copy",
                 (bool (*)(const QString &, const QString &)) & QFile::copy),
             def("exists", (bool (*)(const QString &)) & QFile::exists),
             def("link",
                 (bool (*)(const QString &, const QString &)) & QFile::link),
             def("permissions",
                 (QFile::Permissions(*)(const QString &)) & QFile::permissions),
             def("remove", (bool (*)(const QString &)) & QFile::remove),
             def("rename",
                 (bool (*)(const QString &, const QString &)) & QFile::rename),
             def("resize", (bool (*)(const QString &, qint64)) & QFile::resize),
             def("setPermissions",
                 (bool (*)(const QString &, QFile::Permissions)) &
                     QFile::setPermissions),
             def("symLinkTarget",
                 (QString(*)(const QString &)) & QFile::symLinkTarget)];
}

LQTemporaryFile lqtemporaryfile() {
  return class_<QTemporaryFile, QFile>("QTemporaryFile")
      .def(constructor<>())
      .def(constructor<const QString &>())
      .def(constructor<QObject *>())
      .def(constructor<const QString &, QObject *>())
      ...
      .property("autoRemove", &QTemporaryFile::autoRemove,
                &QTemporaryFile::setAutoRemove)
      .property("fileTemplate", &QTemporaryFile::fileTemplate,
                &QTemporaryFile::setFileTemplate)
      .property("fileName", &QTemporaryFile::fileName)

      .scope[def("createLocalFile", (QTemporaryFile * (*)(const QString &)) &
                                        QTemporaryFile::createLocalFile),
             def("createLocalFile", (QTemporaryFile * (*)(QFile &)) &
                                        QTemporaryFile::createLocalFile)];
}

QFileInfoList lqdir_entryInfoList1(QDir *w) { return w->entryInfoList(); }
QFileInfoList lqdir_entryInfoList2(QDir *w, const QStringList &s) {
  return w->entryInfoList(s);
}
QFileInfoList lqdir_entryInfoList3(QDir *w, const QStringList &s,
                                   QDir::Filters f) {
  return w->entryInfoList(s, f);
}
QFileInfoList lqdir_entryInfoList4(QDir *w, const QStringList &s,
                                   QDir::Filters f, QDir::SortFlags sf) {
  return w->entryInfoList(s, f, sf);
}
QFileInfoList lqdir_entryInfoList5(QDir *w, QDir::Filters f) {
  return w->entryInfoList(f);
}
QFileInfoList lqdir_entryInfoList6(QDir *w, QDir::Filters f,
                                   QDir::SortFlags sf) {
  return w->entryInfoList(f, sf);
}

QStringList lqdir_entryList1(QDir *w) { return w->entryList(); }
QStringList lqdir_entryList2(QDir *w, const QStringList &s) {
  return w->entryList(s);
}
QStringList lqdir_entryList3(QDir *w, const QStringList &s, QDir::Filters f) {
  return w->entryList(s, f);
}
QStringList lqdir_entryList4(QDir *w, const QStringList &s, QDir::Filters f,
                             QDir::SortFlags sf) {
  return w->entryList(s, f, sf);
}
QStringList lqdir_entryList5(QDir *w, QDir::Filters f) {
  return w->entryList(f);
}
QStringList lqdir_entryList6(QDir *w, QDir::Filters f, QDir::SortFlags sf) {
  return w->entryList(f, sf);
}

QString lqdir_separator() { return QString(QDir::separator()); }

LQDir lqdir() {
  return class_<QDir>("QDir")
...
LQFileInfo lqfileinfo() {
  return class_<QFileInfo>("QFileInfo")
      ...
      .def("setFile", (void(QFileInfo::*)(const QDir &, const QString &)) &
                          QFileInfo::setFile)
      .def("setFile", (void(QFileInfo::*)(const QFile &)) & QFileInfo::setFile)
      .def("setFile",
           (void(QFileInfo::*)(const QString &)) & QFileInfo::setFile);
}
