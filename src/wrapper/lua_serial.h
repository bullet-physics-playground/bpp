...
template <typename T> QString settingString(T s);

template <typename T> QStringList validValues();
...
typedef void (*pfnTranverse_t)(const QString &name, const QString &setting,
                               bool groupName, void *context);
